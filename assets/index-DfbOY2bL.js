...
`+hM(s.getShaderSource(e),f)}else return a}function mM(s,e){const n=pM(e);return`vec4 ${s}( vec4 value ) { return ${n[0]}( ${n[1]}( value ) ); }`}function gM(s,e){let n;switch(e){case bv:n="Linear";break;case Lv:n="Reinhard";break;case Dv:n="Cineon";break;case Uv:n="ACESFilmic";break;case Nv:n="AgX";break;case Fv:n="Neutral";break;case Iv:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+s+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const vl=new J;function _M(){Mt.getLuminanceCoefficients(vl);const s=vl.x.toFixed(4),e=vl.y.toFixed(4),n=vl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Ho).join(`
`)),f=qf(f),f=ym(f,n),f=Sm(f,n),d=qf(d),d=ym(d,n),d=Sm(d,n),f=Mm(f),d=Mm(d),n.isRawShaderMaterial!==!0&&(I=`#version 300 es
...
}`;function $M(s,e,n){let r=new ag;const a=new pt,u=new pt,f=new Vt,d=new XM({depthPacking:zv}),p=new YM,m={},_=n.maxTextureSize,y={[_r]:Cn,[Cn]:_r,[Ui]:Ui},x=new vr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new pt},radius:{value:4}},vertexShader:qM,fragmentShader:jM}),S=x.clone();S.defines.HORIZONTAL_PASS=1;const w=new mi;w.setAttribute("position",new jn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new Fi(w,x),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Nm;let v=this.type;this.render=function(k,U,q){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||k.length===0)return;const Se=s.getRenderTarget(),E=s.getActiveCubeFace(),R=s.getActiveMipmapLevel(),se=s.state;se.setBlending(pr),se.buffers.color.setClear(1,1,1,1),se.buffers.depth.setTest(!0),se.setScissorTest(!1);const ee=v!==Di&&this.type===Di,le=v===Di&&this.type!==Di;for(let he=0,te=k.length;he<te;he++){const oe=k[he],B=oe.shadow;if(B===void 0){console.warn("THREE.WebGLShadowMap:",oe,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;a.copy(B.mapSize);const ue=B.getFrameExtents();if(a.multiply(ue),u.copy(B.mapSize),(a.x>_||a.y>_)&&(a.x>_&&(u.x=Math.floor(_/ue.x),a.x=u.x*ue.x,B.mapSize.x=u.x),a.y>_&&(u.y=Math.floor(_/ue.y),a.y=u.y*ue.y,B.mapSize.y=u.y)),B.map===null||ee===!0||le===!0){const N=this.type!==Di?{minFilter:qn,magFilter:qn}:{};B.map!==null&&B.map.dispose(),B.map=new qr(a.x,a.y,N),B.map.texture.name=oe.name+".shadowMap",B.camera.updateProjectionMatrix()}s.setRenderTarget(B.map),s.clear();const re=B.getViewportCount();for(let N=0;N<re;N++){const ne=B.getViewport(N);f.set(u.x*ne.x,u.y*ne.y,u.x*ne.z,u.y*ne.w),se.viewport(f),B.updateMatrices(oe,N),r=B.getFrustum(),D(U,q,B.camera,oe,this.type)}B.isPointLightShadow!==!0&&this.type===Di&&I(B,q),B.needsUpdate=!1}v=this.type,g.needsUpdate=!1,s.setRenderTarget(Se,E,R)};function I(k,U){const q=e.update(C);x.defines.VSM_SAMPLES!==k.blurSamples&&(x.defines.VSM_SAMPLES=k.blurSamples,S.defines.VSM_SAMPLES=k.blurSamples,x.needsUpdate=!0,S.needsUpdate=!0),k.mapPass===null&&(k.mapPass=new qr(a.x,a.y)),x.uniforms.shadow_pass.value=k.map.texture,x.uniforms.resolution.value=k.mapSize,x.uniforms.radius.value=k.radius,s.setRenderTarget(k.mapPass),s.clear(),s.renderBufferDirect(U,null,q,x,C,null),S.uniforms.shadow_pass.value=k.mapPass.texture,S.uniforms.resolution.value=k.mapSize,S.uniforms.radius.value=k.radius,s.setRenderTarget(k.map),s.clear(),s.renderBufferDirect(U,null,q,S,C,null)}function P(k,U,q,Se){let E=null;const R=q.isPointLight===!0?k.customDistanceMaterial:k.customDepthMaterial;if(R!==void 0)E=R;else if(E=q.isPointLight===!0?p:d,s.localClippingEnabled&&U.clipShadows===!0&&Array.isArray(U.clippingPlanes)&&U.clippingPlanes.length!==0||U.displacementMap&&U.displacementScale!==0||U.alphaMap&&U.alphaTest>0||U.map&&U.alphaTest>0){const se=E.uuid,ee=U.uuid;let le=m[se];le===void 0&&(le={},m[se]=le);let he=le[ee];he===void 0&&(he=E.clone(),le[ee]=he,U.addEventListener("dispose",j)),E=he}if(E.visible=U.visible,E.wireframe=U.wireframe,Se===Di?E.side=U.shadowSide!==null?U.shadowSide:U.side:E.side=U.shadowSide!==null?U.shadowSide:y[U.side],E.alphaMap=U.alphaMap,E.alphaTest=U.alphaTest,E.map=U.map,E.clipShadows=U.clipShadows,E.clippingPlanes=U.clippingPlanes,E.clipIntersection=U.clipIntersection,E.displacementMap=U.displacementMap,E.displacementScale=U.displacementScale,E.displacementBias=U.displacementBias,E.wireframeLinewidth=U.wireframeLinewidth,E.linewidth=U.linewidth,q.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const se=s.properties.get(E);se.light=q}return E}function D(k,U,q,Se,E){if(k.visible===!1)return;if(k.layers.test(U.layers)&&(k.isMesh||k.isLine||k.isPoints)&&(k.castShadow||k.receiveShadow&&E===Di)&&(!k.frustumCulled||r.intersectsObject(k))){k.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,k.matrixWorld);const ee=e.update(k),le=k.material;if(Array.isArray(le)){const he=ee.groups;for(let te=0,oe=he.length;te<oe;te++){const B=he[te],ue=le[B.materialIndex];if(ue&&ue.visible){const re=P(k,ue,Se,E);k.onBeforeShadow(s,k,U,q,ee,re,B),s.renderBufferDirect(q,null,ee,re,k,B),k.onAfterShadow(s,k,U,q,ee,re,B)}}}else if(le.visible){const he=P(k,le,Se,E);k.onBeforeShadow(s,k,U,q,ee,he,null),s.renderBufferDirect(q,null,ee,he,k,null),k.onAfterShadow(s,k,U,q,ee,he,null)}}const se=k.children;for(let ee=0,le=se.length;ee<le;ee++)D(se[ee],U,q,Se,E)}function j(k){k.target.removeEventListener("dispose",j);for(const q in m){const Se=m[q],E=k.target.uuid;E in Se&&(Se[E].dispose(),delete Se[E])}}}const KM={[lf]:uf,[cf]:hf,[ff]:pf,[Vs]:df,[uf]:lf,[hf]:cf,[pf]:ff,[df]:Vs};function ZM(s){function e(){let H=!1;const be=new Vt;let ie=null;const de=new Vt(0,0,0,0);return{setMask:function(Ae){ie!==Ae&&!H&&(s.colorMask(Ae,Ae,Ae,Ae),ie=Ae)},setLocked:function(Ae){H=Ae},setClear:function(Ae,De,ct,Ft,rn){rn===!0&&(Ae*=Ft,De*=Ft,ct*=Ft),be.set(Ae,De,ct,Ft),de.equals(be)===!1&&(s.clearColor(Ae,De,ct,Ft),de.copy(be))},reset:function(){H=!1,ie=null,de.set(-1,0,0,0)}}}function n(){let H=!1,be=!1,ie=null,de=null,Ae=null;return{setReversed:function(De){be=De},setTest:function(De){De?ve(s.DEPTH_TEST):xe(s.DEPTH_TEST)},setMask:function(De){ie!==De&&!H&&(s.depthMask(De),ie=De)},setFunc:function(De){if(be&&(De=KM[De]),de!==De){switch(De){case lf:s.depthFunc(s.NEVER);break;case uf:s.depthFunc(s.ALWAYS);break;case cf:s.depthFunc(s.LESS);break;case Vs:s.depthFunc(s.LEQUAL);break;case ff:s.depthFunc(s.EQUAL);break;case df:s.depthFunc(s.GEQUAL);break;case hf:s.depthFunc(s.GREATER);break;case pf:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}de=De}},setLocked:function(De){H=De},setClear:function(De){Ae!==De&&(s.clearDepth(De),Ae=De)},reset:function(){H=!1,ie=null,de=null,Ae=null}}}function r(){let H=!1,be=null,ie=null,de=null,Ae=null,De=null,ct=null,Ft=null,rn=null;return{setTest:function(ht){H||(ht?ve(s.STENCIL_TEST):xe(s.STENCIL_TEST))},setMask:function(ht){be!==ht&&!H&&(s.stencilMask(ht),be=ht)},setFunc:function(ht,Kt,Fn){(ie!==ht||de!==Kt||Ae!==Fn)&&(s.stencilFunc(ht,Kt,Fn),ie=ht,de=Kt,Ae=Fn)},setOp:function(ht,Kt,Fn){(De!==ht||ct!==Kt||Ft!==Fn)&&(s.stencilOp(ht,Kt,Fn),De=ht,ct=Kt,Ft=Fn)},setLocked:function(ht){H=ht},setClear:function(ht){rn!==ht&&(s.clearStencil(ht),rn=ht)},reset:function(){H=!1,be=null,ie=null,de=null,Ae=null,De=null,ct=null,Ft=null,rn=null}}}const a=new e,u=new n,f=new r,d=new WeakMap,p=new WeakMap;let m={},_={},y=new WeakMap,x=[],S=null,w=!1,C=null,g=null,v=null,I=null,P=null,D=null,j=null,k=new Et(0,0,0),U=0,q=!1,Se=null,E=null,R=null,se=null,ee=null;const le=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let he=!1,te=0;const oe=s.getParameter(s.VERSION);oe.indexOf("WebGL")!==-1?(te=parseFloat(/^WebGL (\d)/.exec(oe)[1]),he=te>=1):oe.indexOf("OpenGL ES")!==-1&&(te=parseFloat(/^OpenGL ES (\d)/.exec(oe)[1]),he=te>=2);let B=null,ue={};const re=s.getParameter(s.SCISSOR_BOX),N=s.getParameter(s.VIEWPORT),ne=new Vt().fromArray(re),Ie=new Vt().fromArray(N);function $(H,be,ie,de){const Ae=new Uint8Array(4),De=s.createTexture();s.bindTexture(H,De),s.texParameteri(H,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(H,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let ct=0;ct<ie;ct++)H===s.TEXTURE_3D||H===s.TEXTURE_2D_ARRAY?s.texImage3D(be,0,s.RGBA,1,1,de,0,s.RGBA,s.UNSIGNED_BYTE,Ae):s.texImage2D(be+ct,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Ae);return De}const ae={};ae[s.TEXTURE_2D]=$(s.TEXTURE_2D,s.TEXTURE_2D,1),ae[s.TEXTURE_CUBE_MAP]=$(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),ae[s.TEXTURE_2D_ARRAY]=$(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),ae[s.TEXTURE_3D]=$(s.TEXTURE_3D,s.TEXTURE_3D,1,1),a.setClear(0,0,0,1),u.setClear(1),f.setClear(0),ve(s.DEPTH_TEST),u.setFunc(Vs),at(!1),ft(Fp),ve(s.CULL_FACE),O(pr);function ve(H){m[H]!==!0&&(s.enable(H),m[H]=!0)}function xe(H){m[H]!==!1&&(s.disable(H),m[H]=!1)}function Re(H,be){return _[H]!==be?(s.bindFramebuffer(H,be),_[H]=be,H===s.DRAW_FRAMEBUFFER&&(_[s.FRAMEBUFFER]=be),H===s.FRAMEBUFFER&&(_[s.DRAW_FRAMEBUFFER]=be),!0):!1}function Pe(H,be){let ie=x,de=!1;if(H){ie=y.get(be),ie===void 0&&(ie=[],y.set(be,ie));const Ae=H.textures;if(ie.length!==Ae.length||ie[0]!==s.COLOR_ATTACHMENT0){for(let De=0,ct=Ae.length;De<ct;De++)ie[De]=s.COLOR_ATTACHMENT0+De;ie.length=Ae.length,de=!0}}else ie[0]!==s.BACK&&(ie[0]=s.BACK,de=!0);de&&s.drawBuffers(ie)}function Je(H){return S!==H?(s.useProgram(H),S=H,!0):!1}const mt={[Hr]:s.FUNC_ADD,[fv]:s.FUNC_SUBTRACT,[dv]:s.FUNC_REVERSE_SUBTRACT};mt[hv]=s.MIN,mt[pv]=s.MAX;const lt={[mv]:s.ZERO,[gv]:s.ONE,[_v]:s.SRC_COLOR,[of]:s.SRC_ALPHA,[Ev]:s.SRC_ALPHA_SATURATE,[Sv]:s.DST_COLOR,[xv]:s.DST_ALPHA,[vv]:s.ONE_MINUS_SRC_COLOR,[af]:s.ONE_MINUS_SRC_ALPHA,[Mv]:s.ONE_MINUS_DST_COLOR,[yv]:s.ONE_MINUS_DST_ALPHA,[Tv]:s.CONSTANT_COLOR,[wv]:s.ONE_MINUS_CONSTANT_COLOR,[Av]:s.CONSTANT_ALPHA,[Cv]:s.ONE_MINUS_CONSTANT_ALPHA};function O(H,be,ie,de,Ae,De,ct,Ft,rn,ht){if(H===pr){w===!0&&(xe(s.BLEND),w=!1);return}if(w===!1&&(ve(s.BLEND),w=!0),H!==cv){if(H!==C||ht!==q){if((g!==Hr||P!==Hr)&&(s.blendEquation(s.FUNC_ADD),g=Hr,P=Hr),ht)switch(H){case zs:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case sf:s.blendFunc(s.ONE,s.ONE);break;case Op:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Bp:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}else switch(H){case zs:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case sf:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case Op:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Bp:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}v=null,I=null,D=null,j=null,k.set(0,0,0),U=0,C=H,q=ht}return}Ae=Ae||be,De=De||ie,ct=ct||de,(be!==g||Ae!==P)&&(s.blendEquationSeparate(mt[be],mt[Ae]),g=be,P=Ae),(ie!==v||de!==I||De!==D||ct!==j)&&(s.blendFuncSeparate(lt[ie],lt[de],lt[De],lt[ct]),v=ie,I=de,D=De,j=ct),(Ft.equals(k)===!1||rn!==U)&&(s.blendColor(Ft.r,Ft.g,Ft.b,rn),k.copy(Ft),U=rn),C=H,q=!1}function nn(H,be){H.side===Ui?xe(s.CULL_FACE):ve(s.CULL_FACE);let ie=H.side===Cn;be&&(ie=!ie),at(ie),H.blending===zs&&H.transparent===!1?O(pr):O(H.blending,H.blendEquation,H.blendSrc,H.blendDst,H.blendEquationAlpha,H.blendSrcAlpha,H.blendDstAlpha,H.blendColor,H.blendAlpha,H.premultipliedAlpha),u.setFunc(H.depthFunc),u.setTest(H.depthTest),u.setMask(H.depthWrite),a.setMask(H.colorWrite);const de=H.stencilWrite;f.setTest(de),de&&(f.setMask(H.stencilWriteMask),f.setFunc(H.stencilFunc,H.stencilRef,H.stencilFuncMask),f.setOp(H.stencilFail,H.stencilZFail,H.stencilZPass)),wt(H.polygonOffset,H.polygonOffsetFactor,H.polygonOffsetUnits),H.alphaToCoverage===!0?ve(s.SAMPLE_ALPHA_TO_COVERAGE):xe(s.SAMPLE_ALPHA_TO_COVERAGE)}function at(H){Se!==H&&(H?s.frontFace(s.CW):s.frontFace(s.CCW),Se=H)}function ft(H){H!==av?(ve(s.CULL_FACE),H!==E&&(H===Fp?s.cullFace(s.BACK):H===lv?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):xe(s.CULL_FACE),E=H}function $e(H){H!==R&&(he&&s.lineWidth(H),R=H)}function wt(H,be,ie){H?(ve(s.POLYGON_OFFSET_FILL),(se!==be||ee!==ie)&&(s.polygonOffset(be,ie),se=be,ee=ie)):xe(s.POLYGON_OFFSET_FILL)}function Ze(H){H?ve(s.SCISSOR_TEST):xe(s.SCISSOR_TEST)}function b(H){H===void 0&&(H=s.TEXTURE0+le-1),B!==H&&(s.activeTexture(H),B=H)}function T(H,be,ie){ie===void 0&&(B===null?ie=s.TEXTURE0+le-1:ie=B);let de=ue[ie];de===void 0&&(de={type:void 0,texture:void 0},ue[ie]=de),(de.type!==H||de.texture!==be)&&(B!==ie&&(s.activeTexture(ie),B=ie),s.bindTexture(H,be||ae[H]),de.type=H,de.texture=be)}function Y(){const H=ue[B];H!==void 0&&H.type!==void 0&&(s.bindTexture(H.type,null),H.type=void 0,H.texture=void 0)}function fe(){try{s.compressedTexImage2D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ge(){try{s.compressedTexImage3D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ce(){try{s.texSubImage2D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Xe(){try{s.texSubImage3D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function we(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Ne(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function dt(){try{s.texStorage2D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ye(){try{s.texStorage3D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Fe(){try{s.texImage2D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function et(){try{s.texImage3D.apply(s,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Qe(H){ne.equals(H)===!1&&(s.scissor(H.x,H.y,H.z,H.w),ne.copy(H))}function Be(H){Ie.equals(H)===!1&&(s.viewport(H.x,H.y,H.z,H.w),Ie.copy(H))}function ut(H,be){let ie=p.get(be);ie===void 0&&(ie=new WeakMap,p.set(be,ie));let de=ie.get(H);de===void 0&&(de=s.getUniformBlockIndex(be,H.name),ie.set(H,de))}function nt(H,be){const de=p.get(be).get(H);d.get(be)!==de&&(s.uniformBlockBinding(be,de,H.__bindingPointIndex),d.set(be,de))}function St(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),m={},B=null,ue={},_={},y=new WeakMap,x=[],S=null,w=!1,C=null,g=null,v=null,I=null,P=null,D=null,j=null,k=new Et(0,0,0),U=0,q=!1,Se=null,E=null,R=null,se=null,ee=null,ne.set(0,0,s.canvas.width,s.canvas.height),Ie.set(0,0,s.canvas.width,s.canvas.height),a.reset(),u.reset(),f.reset()}return{buffers:{color:a,depth:u,stencil:f},enable:ve,disable:xe,bindFramebuffer:Re,drawBuffers:Pe,useProgram:Je,setBlending:O,setMaterial:nn,setFlipSided:at,setCullFace:ft,setLineWidth:$e,setPolygonOffset:wt,setScissorTest:Ze,activeTexture:b,bindTexture:T,unbindTexture:Y,compressedTexImage2D:fe,compressedTexImage3D:ge,texImage2D:Fe,texImage3D:et,updateUBOMapping:ut,uniformBlockBinding:nt,texStorage2D:dt,texStorage3D:ye,texSubImage2D:ce,texSubImage3D:Xe,compressedTexSubImage2D:we,compressedTexSubImage3D:Ne,scissor:Qe,viewport:Be,reset:St}}function Cm(s,e,n,r){const a=QM(r);switch(n){case Hm:return s*e;case Gm:return s*e;case Wm:return s*e*2;case Xm:return s*e/a.components*a.byteLength;case ed:return s*e/a.components*a.byteLength;case Ym:return s*e*2/a.components*a.byteLength;case td:return s*e*2/a.components*a.byteLength;case Vm:return s*e*3/a.components*a.byteLength;case oi:return s*e*4/a.components*a.byteLength;case nd:return s*e*4/a.components*a.byteLength;case wl:case Al:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*8;case Cl:case Rl:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case yf:case Mf:return Math.max(s,16)*Math.max(e,8)/4;case xf:case Sf:return Math.max(s,8)*Math.max(e,8)/2;case Ef:case Tf:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*8;case wf:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case Af:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case Cf:return Math.floor((s+4)/5)*Math.floor((e+3)/4)*16;case Rf:return Math.floor((s+4)/5)*Math.floor((e+4)/5)*16;case Pf:return Math.floor((s+5)/6)*Math.floor((e+4)/5)*16;case bf:return Math.floor((s+5)/6)*Math.floor((e+5)/6)*16;case Lf:return Math.floor((s+7)/8)*Math.floor((e+4)/5)*16;case Df:return Math.floor((s+7)/8)*Math.floor((e+5)/6)*16;case Uf:return Math.floor((s+7)/8)*Math.floor((e+7)/8)*16;case If:return Math.floor((s+9)/10)*Math.floor((e+4)/5)*16;case Nf:return Math.floor((s+9)/10)*Math.floor((e+5)/6)*16;case Ff:return Math.floor((s+9)/10)*Math.floor((e+7)/8)*16;case Of:return Math.floor((s+9)/10)*Math.floor((e+9)/10)*16;case Bf:return Math.floor((s+11)/12)*Math.floor((e+9)/10)*16;case zf:return Math.floor((s+11)/12)*Math.floor((e+11)/12)*16;case Pl:case kf:case Hf:return Math.ceil(s/4)*Math.ceil(e/4)*16;case qm:case Vf:return Math.ceil(s/4)*Math.ceil(e/4)*8;case Gf:case Wf:return Math.ceil(s/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function QM(s){switch(s){case Oi:case Bm:return{byteLength:1,components:1};case Vo:case zm:case Go:return{byteLength:2,components:1};case Qf:case Jf:return{byteLength:2,components:4};case Yr:case Zf:case Ii:return{byteLength:4,components:1};case km:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${s}.`)}function JM(s,e,n,r,a,u,f){const d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),m=new pt,_=new WeakMap;let y;const x=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function w(b,T){return S?new OffscreenCanvas(b,T):Fl("canvas")}function C(b,T,Y){let fe=1;const ge=Ze(b);if((ge.width>Y||ge.height>Y)&&(fe=Y/Math.max(ge.width,ge.height)),fe<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const ce=Math.floor(fe*ge.width),Xe=Math.floor(fe*ge.height);y===void 0&&(y=w(ce,Xe));const we=T?w(ce,Xe):y;return we.width=ce,we.height=Xe,we.getContext("2d").drawImage(b,0,0,ce,Xe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ge.width+"x"+ge.height+") to ("+ce+"x"+Xe+")."),we}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ge.width+"x"+ge.height+")."),b;return b}function g(b){return b.generateMipmaps&&b.minFilter!==qn&&b.minFilter!==si}function v(b){s.generateMipmap(b)}function I(b,T,Y,fe,ge=!1){if(b!==null){if(s[b]!==void 0)return s[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let ce=T;if(T===s.RED&&(Y===s.FLOAT&&(ce=s.R32F),Y===s.HALF_FLOAT&&(ce=s.R16F),Y===s.UNSIGNED_BYTE&&(ce=s.R8)),T===s.RED_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ce=s.R8UI),Y===s.UNSIGNED_SHORT&&(ce=s.R16UI),Y===s.UNSIGNED_INT&&(ce=s.R32UI),Y===s.BYTE&&(ce=s.R8I),Y===s.SHORT&&(ce=s.R16I),Y===s.INT&&(ce=s.R32I)),T===s.RG&&(Y===s.FLOAT&&(ce=s.RG32F),Y===s.HALF_FLOAT&&(ce=s.RG16F),Y===s.UNSIGNED_BYTE&&(ce=s.RG8)),T===s.RG_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ce=s.RG8UI),Y===s.UNSIGNED_SHORT&&(ce=s.RG16UI),Y===s.UNSIGNED_INT&&(ce=s.RG32UI),Y===s.BYTE&&(ce=s.RG8I),Y===s.SHORT&&(ce=s.RG16I),Y===s.INT&&(ce=s.RG32I)),T===s.RGB_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ce=s.RGB8UI),Y===s.UNSIGNED_SHORT&&(ce=s.RGB16UI),Y===s.UNSIGNED_INT&&(ce=s.RGB32UI),Y===s.BYTE&&(ce=s.RGB8I),Y===s.SHORT&&(ce=s.RGB16I),Y===s.INT&&(ce=s.RGB32I)),T===s.RGBA_INTEGER&&(Y===s.UNSIGNED_BYTE&&(ce=s.RGBA8UI),Y===s.UNSIGNED_SHORT&&(ce=s.RGBA16UI),Y===s.UNSIGNED_INT&&(ce=s.RGBA32UI),Y===s.BYTE&&(ce=s.RGBA8I),Y===s.SHORT&&(ce=s.RGBA16I),Y===s.INT&&(ce=s.RGBA32I)),T===s.RGB&&Y===s.UNSIGNED_INT_5_9_9_9_REV&&(ce=s.RGB9_E5),T===s.RGBA){const Xe=ge?Dl:Mt.getTransfer(fe);Y===s.FLOAT&&(ce=s.RGBA32F),Y===s.HALF_FLOAT&&(ce=s.RGBA16F),Y===s.UNSIGNED_BYTE&&(ce=Xe===Ut?s.SRGB8_ALPHA8:s.RGBA8),Y===s.UNSIGNED_SHORT_4_4_4_4&&(ce=s.RGBA4),Y===s.UNSIGNED_SHORT_5_5_5_1&&(ce=s.RGB5_A1)}return(ce===s.R16F||ce===s.R32F||ce===s.RG16F||ce===s.RG32F||ce===s.RGBA16F||ce===s.RGBA32F)&&e.get("EXT_color_buffer_float"),ce}function P(b,T){let Y;return b?T===null||T===Yr||T===Xs?Y=s.DEPTH24_STENCIL8:T===Ii?Y=s.DEPTH32F_STENCIL8:T===Vo&&(Y=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===Yr||T===Xs?Y=s.DEPTH_COMPONENT24:T===Ii?Y=s.DEPTH_COMPONENT32F:T===Vo&&(Y=s.DEPTH_COMPONENT16),Y}function D(b,T){return g(b)===!0||b.isFramebufferTexture&&b.minFilter!==qn&&b.minFilter!==si?Math.log2(Math.max(T.width,T.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?T.mipmaps.length:1}function j(b){const T=b.target;T.removeEventListener("dispose",j),U(T),T.isVideoTexture&&_.delete(T)}function k(b){const T=b.target;T.removeEventListener("dispose",k),Se(T)}function U(b){const T=r.get(b);if(T.__webglInit===void 0)return;const Y=b.source,fe=x.get(Y);if(fe){const ge=fe[T.__cacheKey];ge.usedTimes--,ge.usedTimes===0&&q(b),Object.keys(fe).length===0&&x.delete(Y)}r.remove(b)}function q(b){const T=r.get(b);s.deleteTexture(T.__webglTexture);const Y=b.source,fe=x.get(Y);delete fe[T.__cacheKey],f.memory.textures--}function Se(b){const T=r.get(b);if(b.depthTexture&&b.depthTexture.dispose(),b.isWebGLCubeRenderTarget)for(let fe=0;fe<6;fe++){if(Array.isArray(T.__webglFramebuffer[fe]))for(let ge=0;ge<T.__webglFramebuffer[fe].length;ge++)s.deleteFramebuffer(T.__webglFramebuffer[fe][ge]);else s.deleteFramebuffer(T.__webglFramebuffer[fe]);T.__webglDepthbuffer&&s.deleteRenderbuffer(T.__webglDepthbuffer[fe])}else{if(Array.isArray(T.__webglFramebuffer))for(let fe=0;fe<T.__webglFramebuffer.length;fe++)s.deleteFramebuffer(T.__webglFramebuffer[fe]);else s.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&s.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&s.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let fe=0;fe<T.__webglColorRenderbuffer.length;fe++)T.__webglColorRenderbuffer[fe]&&s.deleteRenderbuffer(T.__webglColorRenderbuffer[fe]);T.__webglDepthRenderbuffer&&s.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const Y=b.textures;for(let fe=0,ge=Y.length;fe<ge;fe++){const ce=r.get(Y[fe]);ce.__webglTexture&&(s.deleteTexture(ce.__webglTexture),f.memory.textures--),r.remove(Y[fe])}r.remove(b)}let E=0;function R(){E=0}function se(){const b=E;return b>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+a.maxTextures),E+=1,b}function ee(b){const T=[];return T.push(b.wrapS),T.push(b.wrapT),T.push(b.wrapR||0),T.push(b.magFilter),T.push(b.minFilter),T.push(b.anisotropy),T.push(b.internalFormat),T.push(b.format),T.push(b.type),T.push(b.generateMipmaps),T.push(b.premultiplyAlpha),T.push(b.flipY),T.push(b.unpackAlignment),T.push(b.colorSpace),T.join()}function le(b,T){const Y=r.get(b);if(b.isVideoTexture&&$e(b),b.isRenderTargetTexture===!1&&b.version>0&&Y.__version!==b.version){const fe=b.image;if(fe===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(fe.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ie(Y,b,T);return}}n.bindTexture(s.TEXTURE_2D,Y.__webglTexture,s.TEXTURE0+T)}function he(b,T){const Y=r.get(b);if(b.version>0&&Y.__version!==b.version){Ie(Y,b,T);return}n.bindTexture(s.TEXTURE_2D_ARRAY,Y.__webglTexture,s.TEXTURE0+T)}function te(b,T){const Y=r.get(b);if(b.version>0&&Y.__version!==b.version){Ie(Y,b,T);return}n.bindTexture(s.TEXTURE_3D,Y.__webglTexture,s.TEXTURE0+T)}function oe(b,T){const Y=r.get(b);if(b.version>0&&Y.__version!==b.version){$(Y,b,T);return}n.bindTexture(s.TEXTURE_CUBE_MAP,Y.__webglTexture,s.TEXTURE0+T)}const B={[_f]:s.REPEAT,[Gr]:s.CLAMP_TO_EDGE,[vf]:s.MIRRORED_REPEAT},ue={[qn]:s.NEAREST,[Ov]:s.NEAREST_MIPMAP_NEAREST,[Qa]:s.NEAREST_MIPMAP_LINEAR,[si]:s.LINEAR,[wc]:s.LINEAR_MIPMAP_NEAREST,[Wr]:s.LINEAR_MIPMAP_LINEAR},re={[Vv]:s.NEVER,[jv]:s.ALWAYS,[Gv]:s.LESS,[jm]:s.LEQUAL,[Wv]:s.EQUAL,[qv]:s.GEQUAL,[Xv]:s.GREATER,[Yv]:s.NOTEQUAL};function N(b,T){if(T.type===Ii&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===si||T.magFilter===wc||T.magFilter===Qa||T.magFilter===Wr||T.minFilter===si||T.minFilter===wc||T.minFilter===Qa||T.minFilter===Wr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(b,s.TEXTURE_WRAP_S,B[T.wrapS]),s.texParameteri(b,s.TEXTURE_WRAP_T,B[T.wrapT]),(b===s.TEXTURE_3D||b===s.TEXTURE_2D_ARRAY)&&s.texParameteri(b,s.TEXTURE_WRAP_R,B[T.wrapR]),s.texParameteri(b,s.TEXTURE_MAG_FILTER,ue[T.magFilter]),s.texParameteri(b,s.TEXTURE_MIN_FILTER,ue[T.minFilter]),T.compareFunction&&(s.texParameteri(b,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(b,s.TEXTURE_COMPARE_FUNC,re[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===qn||T.minFilter!==Qa&&T.minFilter!==Wr||T.type===Ii&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||r.get(T).__currentAnisotropy){const Y=e.get("EXT_texture_filter_anisotropic");s.texParameterf(b,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,a.getMaxAnisotropy())),r.get(T).__currentAnisotropy=T.anisotropy}}}function ne(b,T){let Y=!1;b.__webglInit===void 0&&(b.__webglInit=!0,T.addEventListener("dispose",j));const fe=T.source;let ge=x.get(fe);ge===void 0&&(ge={},x.set(fe,ge));const ce=ee(T);if(ce!==b.__cacheKey){ge[ce]===void 0&&(ge[ce]={texture:s.createTexture(),usedTimes:0},f.memory.textures++,Y=!0),ge[ce].usedTimes++;const Xe=ge[b.__cacheKey];Xe!==void 0&&(ge[b.__cacheKey].usedTimes--,Xe.usedTimes===0&&q(T)),b.__cacheKey=ce,b.__webglTexture=ge[ce].texture}return Y}function Ie(b,T,Y){let fe=s.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(fe=s.TEXTURE_2D_ARRAY),T.isData3DTexture&&(fe=s.TEXTURE_3D);const ge=ne(b,T),ce=T.source;n.bindTexture(fe,b.__webglTexture,s.TEXTURE0+Y);const Xe=r.get(ce);if(ce.version!==Xe.__version||ge===!0){n.activeTexture(s.TEXTURE0+Y);const we=Mt.getPrimaries(Mt.workingColorSpace),Ne=T.colorSpace===hr?null:Mt.getPrimaries(T.colorSpace),dt=T.colorSpace===hr||we===Ne?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,T.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,T.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,dt);let ye=C(T.image,!1,a.maxTextureSize);ye=wt(T,ye);const Fe=u.convert(T.format,T.colorSpace),et=u.convert(T.type);let Qe=I(T.internalFormat,Fe,et,T.colorSpace,T.isVideoTexture);N(fe,T);let Be;const ut=T.mipmaps,nt=T.isVideoTexture!==!0,St=Xe.__version===void 0||ge===!0,H=ce.dataReady,be=D(T,ye);if(T.isDepthTexture)Qe=P(T.format===Ys,T.type),St&&(nt?n.texStorage2D(s.TEXTURE_2D,1,Qe,ye.width,ye.height):n.texImage2D(s.TEXTURE_2D,0,Qe,ye.width,ye.height,0,Fe,et,null));else if(T.isDataTexture)if(ut.length>0){nt&&St&&n.texStorage2D(s.TEXTURE_2D,be,Qe,ut[0].width,ut[0].height);for(let ie=0,de=ut.length;ie<de;ie++)Be=ut[ie],nt?H&&n.texSubImage2D(s.TEXTURE_2D,ie,0,0,Be.width,Be.height,Fe,et,Be.data):n.texImage2D(s.TEXTURE_2D,ie,Qe,Be.width,Be.height,0,Fe,et,Be.data);T.generateMipmaps=!1}else nt?(St&&n.texStorage2D(s.TEXTURE_2D,be,Qe,ye.width,ye.height),H&&n.texSubImage2D(s.TEXTURE_2D,0,0,0,ye.width,ye.height,Fe,et,ye.data)):n.texImage2D(s.TEXTURE_2D,0,Qe,ye.width,ye.height,0,Fe,et,ye.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){nt&&St&&n.texStorage3D(s.TEXTURE_2D_ARRAY,be,Qe,ut[0].width,ut[0].height,ye.depth);for(let ie=0,de=ut.length;ie<de;ie++)if(Be=ut[ie],T.format!==oi)if(Fe!==null)if(nt){if(H)if(T.layerUpdates.size>0){const Ae=Cm(Be.width,Be.height,T.format,T.type);for(const De of T.layerUpdates){const ct=Be.data.subarray(De*Ae/Be.data.BYTES_PER_ELEMENT,(De+1)*Ae/Be.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ie,0,0,De,Be.width,Be.height,1,Fe,ct,0,0)}T.clearLayerUpdates()}else n.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ie,0,0,0,Be.width,Be.height,ye.depth,Fe,Be.data,0,0)}else n.compressedTexImage3D(s.TEXTURE_2D_ARRAY,ie,Qe,Be.width,Be.height,ye.depth,0,Be.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else nt?H&&n.texSubImage3D(s.TEXTURE_2D_ARRAY,ie,0,0,0,Be.width,Be.height,ye.depth,Fe,et,Be.data):n.texImage3D(s.TEXTURE_2D_ARRAY,ie,Qe,Be.width,Be.height,ye.depth,0,Fe,et,Be.data)}else{nt&&St&&n.texStorage2D(s.TEXTURE_2D,be,Qe,ut[0].width,ut[0].height);for(let ie=0,de=ut.length;ie<de;ie++)Be=ut[ie],T.format!==oi?Fe!==null?nt?H&&n.compressedTexSubImage2D(s.TEXTURE_2D,ie,0,0,Be.width,Be.height,Fe,Be.data):n.compressedTexImage2D(s.TEXTURE_2D,ie,Qe,Be.width,Be.height,0,Be.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):nt?H&&n.texSubImage2D(s.TEXTURE_2D,ie,0,0,Be.width,Be.height,Fe,et,Be.data):n.texImage2D(s.TEXTURE_2D,ie,Qe,Be.width,Be.height,0,Fe,et,Be.data)}else if(T.isDataArrayTexture)if(nt){if(St&&n.texStorage3D(s.TEXTURE_2D_ARRAY,be,Qe,ye.width,ye.height,ye.depth),H)if(T.layerUpdates.size>0){const ie=Cm(ye.width,ye.height,T.format,T.type);for(const de of T.layerUpdates){const Ae=ye.data.subarray(de*ie/ye.data.BYTES_PER_ELEMENT,(de+1)*ie/ye.data.BYTES_PER_ELEMENT);n.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,de,ye.width,ye.height,1,Fe,et,Ae)}T.clearLayerUpdates()}else n.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ye.width,ye.height,ye.depth,Fe,et,ye.data)}else n.texImage3D(s.TEXTURE_2D_ARRAY,0,Qe,ye.width,ye.height,ye.depth,0,Fe,et,ye.data);else if(T.isData3DTexture)nt?(St&&n.texStorage3D(s.TEXTURE_3D,be,Qe,ye.width,ye.height,ye.depth),H&&n.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ye.width,ye.height,ye.depth,Fe,et,ye.data)):n.texImage3D(s.TEXTURE_3D,0,Qe,ye.width,ye.height,ye.depth,0,Fe,et,ye.data);else if(T.isFramebufferTexture){if(St)if(nt)n.texStorage2D(s.TEXTURE_2D,be,Qe,ye.width,ye.height);else{let ie=ye.width,de=ye.height;for(let Ae=0;Ae<be;Ae++)n.texImage2D(s.TEXTURE_2D,Ae,Qe,ie,de,0,Fe,et,null),ie>>=1,de>>=1}}else if(ut.length>0){if(nt&&St){const ie=Ze(ut[0]);n.texStorage2D(s.TEXTURE_2D,be,Qe,ie.width,ie.height)}for(let ie=0,de=ut.length;ie<de;ie++)Be=ut[ie],nt?H&&n.texSubImage2D(s.TEXTURE_2D,ie,0,0,Fe,et,Be):n.texImage2D(s.TEXTURE_2D,ie,Qe,Fe,et,Be);T.generateMipmaps=!1}else if(nt){if(St){const ie=Ze(ye);n.texStorage2D(s.TEXTURE_2D,be,Qe,ie.width,ie.height)}H&&n.texSubImage2D(s.TEXTURE_2D,0,0,0,Fe,et,ye)}else n.texImage2D(s.TEXTURE_2D,0,Qe,Fe,et,ye);g(T)&&v(fe),Xe.__version=ce.version,T.onUpdate&&T.onUpdate(T)}b.__version=T.version}function $(b,T,Y){if(T.image.length!==6)return;const fe=ne(b,T),ge=T.source;n.bindTexture(s.TEXTURE_CUBE_MAP,b.__webglTexture,s.TEXTURE0+Y);const ce=r.get(ge);if(ge.version!==ce.__version||fe===!0){n.activeTexture(s.TEXTURE0+Y);const Xe=Mt.getPrimaries(Mt.workingColorSpace),we=T.colorSpace===hr?null:Mt.getPrimaries(T.colorSpace),Ne=T.colorSpace===hr||Xe===we?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,T.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,T.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ne);const dt=T.isCompressedTexture||T.image[0].isCompressedTexture,ye=T.image[0]&&T.image[0].isDataTexture,Fe=[];for(let de=0;de<6;de++)!dt&&!ye?Fe[de]=C(T.image[de],!0,a.maxCubemapSize):Fe[de]=ye?T.image[de].image:T.image[de],Fe[de]=wt(T,Fe[de]);const et=Fe[0],Qe=u.convert(T.format,T.colorSpace),Be=u.convert(T.type),ut=I(T.internalFormat,Qe,Be,T.colorSpace),nt=T.isVideoTexture!==!0,St=ce.__version===void 0||fe===!0,H=ge.dataReady;let be=D(T,et);N(s.TEXTURE_CUBE_MAP,T);let ie;if(dt){nt&&St&&n.texStorage2D(s.TEXTURE_CUBE_MAP,be,ut,et.width,et.height);for(let de=0;de<6;de++){ie=Fe[de].mipmaps;for(let Ae=0;Ae<ie.length;Ae++){const De=ie[Ae];T.format!==oi?Qe!==null?nt?H&&n.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae,0,0,De.width,De.height,Qe,De.data):n.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae,ut,De.width,De.height,0,De.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):nt?H&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae,0,0,De.width,De.height,Qe,Be,De.data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae,ut,De.width,De.height,0,Qe,Be,De.data)}}}else{if(ie=T.mipmaps,nt&&St){ie.length>0&&be++;const de=Ze(Fe[0]);n.texStorage2D(s.TEXTURE_CUBE_MAP,be,ut,de.width,de.height)}for(let de=0;de<6;de++)if(ye){nt?H&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,Fe[de].width,Fe[de].height,Qe,Be,Fe[de].data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,ut,Fe[de].width,Fe[de].height,0,Qe,Be,Fe[de].data);for(let Ae=0;Ae<ie.length;Ae++){const ct=ie[Ae].image[de].image;nt?H&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae+1,0,0,ct.width,ct.height,Qe,Be,ct.data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae+1,ut,ct.width,ct.height,0,Qe,Be,ct.data)}}else{nt?H&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,Qe,Be,Fe[de]):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,ut,Qe,Be,Fe[de]);for(let Ae=0;Ae<ie.length;Ae++){const De=ie[Ae];nt?H&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae+1,0,0,Qe,Be,De.image[de]):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae+1,ut,Qe,Be,De.image[de])}}}g(T)&&v(s.TEXTURE_CUBE_MAP),ce.__version=ge.version,T.onUpdate&&T.onUpdate(T)}b.__version=T.version}function ae(b,T,Y,fe,ge,ce){const Xe=u.convert(Y.format,Y.colorSpace),we=u.convert(Y.type),Ne=I(Y.internalFormat,Xe,we,Y.colorSpace);if(!r.get(T).__hasExternalTextures){const ye=Math.max(1,T.width>>ce),Fe=Math.max(1,T.height>>ce);ge===s.TEXTURE_3D||ge===s.TEXTURE_2D_ARRAY?n.texImage3D(ge,ce,Ne,ye,Fe,T.depth,0,Xe,we,null):n.texImage2D(ge,ce,Ne,ye,Fe,0,Xe,we,null)}n.bindFramebuffer(s.FRAMEBUFFER,b),ft(T)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,fe,ge,r.get(Y).__webglTexture,0,at(T)):(ge===s.TEXTURE_2D||ge>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&ge<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,fe,ge,r.get(Y).__webglTexture,ce),n.bindFramebuffer(s.FRAMEBUFFER,null)}function ve(b,T,Y){if(s.bindRenderbuffer(s.RENDERBUFFER,b),T.depthBuffer){const fe=T.depthTexture,ge=fe&&fe.isDepthTexture?fe.type:null,ce=P(T.stencilBuffer,ge),Xe=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,we=at(T);ft(T)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,we,ce,T.width,T.height):Y?s.renderbufferStorageMultisample(s.RENDERBUFFER,we,ce,T.width,T.height):s.renderbufferStorage(s.RENDERBUFFER,ce,T.width,T.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Xe,s.RENDERBUFFER,b)}else{const fe=T.textures;for(let ge=0;ge<fe.length;ge++){const ce=fe[ge],Xe=u.convert(ce.format,ce.colorSpace),we=u.convert(ce.type),Ne=I(ce.internalFormat,Xe,we,ce.colorSpace),dt=at(T);Y&&ft(T)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,dt,Ne,T.width,T.height):ft(T)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,dt,Ne,T.width,T.height):s.renderbufferStorage(s.RENDERBUFFER,Ne,T.width,T.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function xe(b,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(s.FRAMEBUFFER,b),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!r.get(T.depthTexture).__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),le(T.depthTexture,0);const fe=r.get(T.depthTexture).__webglTexture,ge=at(T);if(T.depthTexture.format===ks)ft(T)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,fe,0,ge):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,fe,0);else if(T.depthTexture.format===Ys)ft(T)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,fe,0,ge):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,fe,0);else throw new Error("Unknown depthTexture format")}function Re(b){const T=r.get(b),Y=b.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==b.depthTexture){const fe=b.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),fe){const ge=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,fe.removeEventListener("dispose",ge)};fe.addEventListener("dispose",ge),T.__depthDisposeCallback=ge}T.__boundDepthTexture=fe}if(b.depthTexture&&!T.__autoAllocateDepthBuffer){if(Y)throw new Error("target.depthTexture not supported in Cube render targets");xe(T.__webglFramebuffer,b)}else if(Y){T.__webglDepthbuffer=[];for(let fe=0;fe<6;fe++)if(n.bindFramebuffer(s.FRAMEBUFFER,T.__webglFramebuffer[fe]),T.__webglDepthbuffer[fe]===void 0)T.__webglDepthbuffer[fe]=s.createRenderbuffer(),ve(T.__webglDepthbuffer[fe],b,!1);else{const ge=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ce=T.__webglDepthbuffer[fe];s.bindRenderbuffer(s.RENDERBUFFER,ce),s.framebufferRenderbuffer(s.FRAMEBUFFER,ge,s.RENDERBUFFER,ce)}}else if(n.bindFramebuffer(s.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=s.createRenderbuffer(),ve(T.__webglDepthbuffer,b,!1);else{const fe=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ge=T.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,ge),s.framebufferRenderbuffer(s.FRAMEBUFFER,fe,s.RENDERBUFFER,ge)}n.bindFramebuffer(s.FRAMEBUFFER,null)}function Pe(b,T,Y){const fe=r.get(b);T!==void 0&&ae(fe.__webglFramebuffer,b,b.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),Y!==void 0&&Re(b)}function Je(b){const T=b.texture,Y=r.get(b),fe=r.get(T);b.addEventListener("dispose",k);const ge=b.textures,ce=b.isWebGLCubeRenderTarget===!0,Xe=ge.length>1;if(Xe||(fe.__webglTexture===void 0&&(fe.__webglTexture=s.createTexture()),fe.__version=T.version,f.memory.textures++),ce){Y.__webglFramebuffer=[];for(let we=0;we<6;we++)if(T.mipmaps&&T.mipmaps.length>0){Y.__webglFramebuffer[we]=[];for(let Ne=0;Ne<T.mipmaps.length;Ne++)Y.__webglFramebuffer[we][Ne]=s.createFramebuffer()}else Y.__webglFramebuffer[we]=s.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){Y.__webglFramebuffer=[];for(let we=0;we<T.mipmaps.length;we++)Y.__webglFramebuffer[we]=s.createFramebuffer()}else Y.__webglFramebuffer=s.createFramebuffer();if(Xe)for(let we=0,Ne=ge.length;we<Ne;we++){const dt=r.get(ge[we]);dt.__webglTexture===void 0&&(dt.__webglTexture=s.createTexture(),f.memory.textures++)}if(b.samples>0&&ft(b)===!1){Y.__webglMultisampledFramebuffer=s.createFramebuffer(),Y.__webglColorRenderbuffer=[],n.bindFramebuffer(s.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let we=0;we<ge.length;we++){const Ne=ge[we];Y.__webglColorRenderbuffer[we]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,Y.__webglColorRenderbuffer[we]);const dt=u.convert(Ne.format,Ne.colorSpace),ye=u.convert(Ne.type),Fe=I(Ne.internalFormat,dt,ye,Ne.colorSpace,b.isXRRenderTarget===!0),et=at(b);s.renderbufferStorageMultisample(s.RENDERBUFFER,et,Fe,b.width,b.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+we,s.RENDERBUFFER,Y.__webglColorRenderbuffer[we])}s.bindRenderbuffer(s.RENDERBUFFER,null),b.depthBuffer&&(Y.__webglDepthRenderbuffer=s.createRenderbuffer(),ve(Y.__webglDepthRenderbuffer,b,!0)),n.bindFramebuffer(s.FRAMEBUFFER,null)}}if(ce){n.bindTexture(s.TEXTURE_CUBE_MAP,fe.__webglTexture),N(s.TEXTURE_CUBE_MAP,T);for(let we=0;we<6;we++)if(T.mipmaps&&T.mipmaps.length>0)for(let Ne=0;Ne<T.mipmaps.length;Ne++)ae(Y.__webglFramebuffer[we][Ne],b,T,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+we,Ne);else ae(Y.__webglFramebuffer[we],b,T,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+we,0);g(T)&&v(s.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Xe){for(let we=0,Ne=ge.length;we<Ne;we++){const dt=ge[we],ye=r.get(dt);n.bindTexture(s.TEXTURE_2D,ye.__webglTexture),N(s.TEXTURE_2D,dt),ae(Y.__webglFramebuffer,b,dt,s.COLOR_ATTACHMENT0+we,s.TEXTURE_2D,0),g(dt)&&v(s.TEXTURE_2D)}n.unbindTexture()}else{let we=s.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(we=b.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),n.bindTexture(we,fe.__webglTexture),N(we,T),T.mipmaps&&T.mipmaps.length>0)for(let Ne=0;Ne<T.mipmaps.length;Ne++)ae(Y.__webglFramebuffer[Ne],b,T,s.COLOR_ATTACHMENT0,we,Ne);else ae(Y.__webglFramebuffer,b,T,s.COLOR_ATTACHMENT0,we,0);g(T)&&v(we),n.unbindTexture()}b.depthBuffer&&Re(b)}function mt(b){const T=b.textures;for(let Y=0,fe=T.length;Y<fe;Y++){const ge=T[Y];if(g(ge)){const ce=b.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:s.TEXTURE_2D,Xe=r.get(ge).__webglTexture;n.bindTexture(ce,Xe),v(ce),n.unbindTexture()}}}const lt=[],O=[];function nn(b){if(b.samples>0){if(ft(b)===!1){const T=b.textures,Y=b.width,fe=b.height;let ge=s.COLOR_BUFFER_BIT;const ce=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Xe=r.get(b),we=T.length>1;if(we)for(let Ne=0;Ne<T.length;Ne++)n.bindFramebuffer(s.FRAMEBUFFER,Xe.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ne,s.RENDERBUFFER,null),n.bindFramebuffer(s.FRAMEBUFFER,Xe.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ne,s.TEXTURE_2D,null,0);n.bindFramebuffer(s.READ_FRAMEBUFFER,Xe.__webglMultisampledFramebuffer),n.bindFramebuffer(s.DRAW_FRAMEBUFFER,Xe.__webglFramebuffer);for(let Ne=0;Ne<T.length;Ne++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(ge|=s.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(ge|=s.STENCIL_BUFFER_BIT)),we){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Xe.__webglColorRenderbuffer[Ne]);const dt=r.get(T[Ne]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,dt,0)}s.blitFramebuffer(0,0,Y,fe,0,0,Y,fe,ge,s.NEAREST),p===!0&&(lt.length=0,O.length=0,lt.push(s.COLOR_ATTACHMENT0+Ne),b.depthBuffer&&b.resolveDepthBuffer===!1&&(lt.push(ce),O.push(ce),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,O)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,lt))}if(n.bindFramebuffer(s.READ_FRAMEBUFFER,null),n.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),we)for(let Ne=0;Ne<T.length;Ne++){n.bindFramebuffer(s.FRAMEBUFFER,Xe.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ne,s.RENDERBUFFER,Xe.__webglColorRenderbuffer[Ne]);const dt=r.get(T[Ne]).__webglTexture;n.bindFramebuffer(s.FRAMEBUFFER,Xe.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ne,s.TEXTURE_2D,dt,0)}n.bindFramebuffer(s.DRAW_FRAMEBUFFER,Xe.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&p){const T=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[T])}}}function at(b){return Math.min(a.maxSamples,b.samples)}function ft(b){const T=r.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function $e(b){const T=f.render.frame;_.get(b)!==T&&(_.set(b,T),b.update())}function wt(b,T){const Y=b.colorSpace,fe=b.format,ge=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||Y!==xr&&Y!==hr&&(Mt.getTransfer(Y)===Ut?(fe!==oi||ge!==Oi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",Y)),T}function Ze(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(m.width=b.naturalWidth||b.width,m.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(m.width=b.displayWidth,m.height=b.displayHeight):(m.width=b.width,m.height=b.height),m}this.allocateTextureUnit=se,this.resetTextureUnits=R,this.setTexture2D=le,this.setTexture2DArray=he,this.setTexture3D=te,this.setTextureCube=oe,this.rebindTextures=Pe,this.setupRenderTarget=Je,this.updateRenderTargetMipmap=mt,this.updateMultisampleRenderTarget=nn,this.setupDepthRenderbuffer=Re,this.setupFrameBufferTexture=ae,this.useMultisampledRTT=ft}function eE(s,e){function n(r,a=hr){let u;const f=Mt.getTransfer(a);if(r===Oi)return s.UNSIGNED_BYTE;if(r===Qf)return s.UNSIGNED_SHORT_4_4_4_4;if(r===Jf)return s.UNSIGNED_SHORT_5_5_5_1;if(r===km)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===Bm)return s.BYTE;if(r===zm)return s.SHORT;if(r===Vo)return s.UNSIGNED_SHORT;if(r===Zf)return s.INT;if(r===Yr)return s.UNSIGNED_INT;if(r===Ii)return s.FLOAT;if(r===Go)return s.HALF_FLOAT;if(r===Hm)return s.ALPHA;if(r===Vm)return s.RGB;if(r===oi)return s.RGBA;if(r===Gm)return s.LUMINANCE;if(r===Wm)return s.LUMINANCE_ALPHA;if(r===ks)return s.DEPTH_COMPONENT;if(r===Ys)return s.DEPTH_STENCIL;if(r===Xm)return s.RED;if(r===ed)return s.RED_INTEGER;if(r===Ym)return s.RG;if(r===td)return s.RG_INTEGER;if(r===nd)return s.RGBA_INTEGER;if(r===wl||r===Al||r===Cl||r===Rl)if(f===Ut)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===wl)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Al)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Cl)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Rl)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===wl)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Al)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Cl)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Rl)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===xf||r===yf||r===Sf||r===Mf)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===xf)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===yf)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Sf)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Mf)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Ef||r===Tf||r===wf)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(r===Ef||r===Tf)return f===Ut?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===wf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Af||r===Cf||r===Rf||r===Pf||r===bf||r===Lf||r===Df||r===Uf||r===If||r===Nf||r===Ff||r===Of||r===Bf||r===zf)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(r===Af)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Cf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Rf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Pf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===bf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Lf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Df)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Uf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===If)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Nf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Ff)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===Of)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===Bf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===zf)return f===Ut?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Pl||r===kf||r===Hf)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(r===Pl)return f===Ut?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===kf)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===Hf)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===qm||r===Vf||r===Gf||r===Wf)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(r===Pl)return u.COMPRESSED_RED_RGTC1_EXT;if(r===Vf)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Gf)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===Wf)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Xs?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:n}}class tE extends Xn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class xl extends xn{constructor(){super(),this.isGroup=!0,this.type="Group"}}const nE={type:"move"};class tf{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new xl,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new xl,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new J,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new J),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new xl,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new J,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new J),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const r of e.hand.values())this._getHandJoint(n,r)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,r){let a=null,u=null,f=null;const d=this._targetRay,p=this._grip,m=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(m&&e.hand){f=!0;for(const C of e.hand.values()){const g=n.getJointPose(C,r),v=this._getHandJoint(m,C);g!==null&&(v.matrix.fromArray(g.transform.matrix),v.matrix.decompose(v.position,v.rotation,v.scale),v.matrixWorldNeedsUpdate=!0,v.jointRadius=g.radius),v.visible=g!==null}const _=m.joints["index-finger-tip"],y=m.joints["thumb-tip"],x=_.position.distanceTo(y.position),S=.02,w=.005;m.inputState.pinching&&x>S+w?(m.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!m.inputState.pinching&&x<=S-w&&(m.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else p!==null&&e.gripSpace&&(u=n.getPose(e.gripSpace,r),u!==null&&(p.matrix.fromArray(u.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,u.linearVelocity?(p.hasLinearVelocity=!0,p.linearVelocity.copy(u.linearVelocity)):p.hasLinearVelocity=!1,u.angularVelocity?(p.hasAngularVelocity=!0,p.angularVelocity.copy(u.angularVelocity)):p.hasAngularVelocity=!1));d!==null&&(a=n.getPose(e.targetRaySpace,r),a===null&&u!==null&&(a=u),a!==null&&(d.matrix.fromArray(a.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,a.linearVelocity?(d.hasLinearVelocity=!0,d.linearVelocity.copy(a.linearVelocity)):d.hasLinearVelocity=!1,a.angularVelocity?(d.hasAngularVelocity=!0,d.angularVelocity.copy(a.angularVelocity)):d.hasAngularVelocity=!1,this.dispatchEvent(nE)))}return d!==null&&(d.visible=a!==null),p!==null&&(p.visible=u!==null),m!==null&&(m.visible=f!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const r=new xl;r.matrixAutoUpdate=!1,r.visible=!1,e.joints[n.jointName]=r,e.add(r)}return e.joints[n.jointName]}}const iE=`
void main() {
...
}`;class sE{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,r){if(this.texture===null){const a=new vn,u=e.properties.get(a);u.__webglTexture=n.texture,(n.depthNear!=r.depthNear||n.depthFar!=r.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=a}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,r=new vr({vertexShader:iE,fragmentShader:rE,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new Fi(new Hl(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class oE extends js{constructor(e,n){super();const r=this;let a=null,u=1,f=null,d="local-floor",p=1,m=null,_=null,y=null,x=null,S=null,w=null;const C=new sE,g=n.getContextAttributes();let v=null,I=null;const P=[],D=[],j=new pt;let k=null;const U=new Xn;U.layers.enable(1),U.viewport=new Vt;const q=new Xn;q.layers.enable(2),q.viewport=new Vt;const Se=[U,q],E=new tE;E.layers.enable(1),E.layers.enable(2);let R=null,se=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let ae=P[$];return ae===void 0&&(ae=new tf,P[$]=ae),ae.getTargetRaySpace()},this.getControllerGrip=function($){let ae=P[$];return ae===void 0&&(ae=new tf,P[$]=ae),ae.getGripSpace()},this.getHand=function($){let ae=P[$];return ae===void 0&&(ae=new tf,P[$]=ae),ae.getHandSpace()};function ee($){const ae=D.indexOf($.inputSource);if(ae===-1)return;const ve=P[ae];ve!==void 0&&(ve.update($.inputSource,$.frame,m||f),ve.dispatchEvent({type:$.type,data:$.inputSource}))}function le(){a.removeEventListener("select",ee),a.removeEventListener("selectstart",ee),a.removeEventListener("selectend",ee),a.removeEventListener("squeeze",ee),a.removeEventListener("squeezestart",ee),a.removeEventListener("squeezeend",ee),a.removeEventListener("end",le),a.removeEventListener("inputsourceschange",he);for(let $=0;$<P.length;$++){const ae=D[$];ae!==null&&(D[$]=null,P[$].disconnect(ae))}R=null,se=null,C.reset(),e.setRenderTarget(v),S=null,x=null,y=null,a=null,I=null,Ie.stop(),r.isPresenting=!1,e.setPixelRatio(k),e.setSize(j.width,j.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){u=$,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){d=$,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return m||f},this.setReferenceSpace=function($){m=$},this.getBaseLayer=function(){return x!==null?x:S},this.getBinding=function(){return y},this.getFrame=function(){return w},this.getSession=function(){return a},this.setSession=async function($){if(a=$,a!==null){if(v=e.getRenderTarget(),a.addEventListener("select",ee),a.addEventListener("selectstart",ee),a.addEventListener("selectend",ee),a.addEventListener("squeeze",ee),a.addEventListener("squeezestart",ee),a.addEventListener("squeezeend",ee),a.addEventListener("end",le),a.addEventListener("inputsourceschange",he),g.xrCompatible!==!0&&await n.makeXRCompatible(),k=e.getPixelRatio(),e.getSize(j),a.renderState.layers===void 0){const ae={antialias:g.antialias,alpha:!0,depth:g.depth,stencil:g.stencil,framebufferScaleFactor:u};S=new XRWebGLLayer(a,n,ae),a.updateRenderState({baseLayer:S}),e.setPixelRatio(1),e.setSize(S.framebufferWidth,S.framebufferHeight,!1),I=new qr(S.framebufferWidth,S.framebufferHeight,{format:oi,type:Oi,colorSpace:e.outputColorSpace,stencilBuffer:g.stencil})}else{let ae=null,ve=null,xe=null;g.depth&&(xe=g.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ae=g.stencil?Ys:ks,ve=g.stencil?Xs:Yr);const Re={colorFormat:n.RGBA8,depthFormat:xe,scaleFactor:u};y=new XRWebGLBinding(a,n),x=y.createProjectionLayer(Re),a.updateRenderState({layers:[x]}),e.setPixelRatio(1),e.setSize(x.textureWidth,x.textureHeight,!1),I=new qr(x.textureWidth,x.textureHeight,{format:oi,type:Oi,depthTexture:new ug(x.textureWidth,x.textureHeight,ve,void 0,void 0,void 0,void 0,void 0,void 0,ae),stencilBuffer:g.stencil,colorSpace:e.outputColorSpace,samples:g.antialias?4:0,resolveDepthBuffer:x.ignoreDepthValues===!1})}I.isXRRenderTarget=!0,this.setFoveation(p),m=null,f=await a.requestReferenceSpace(d),Ie.setContext(a),Ie.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(a!==null)return a.environmentBlendMode},this.getDepthTexture=function(){return C.getDepthTexture()};function he($){for(let ae=0;ae<$.removed.length;ae++){const ve=$.removed[ae],xe=D.indexOf(ve);xe>=0&&(D[xe]=null,P[xe].disconnect(ve))}for(let ae=0;ae<$.added.length;ae++){const ve=$.added[ae];let xe=D.indexOf(ve);if(xe===-1){for(let Pe=0;Pe<P.length;Pe++)if(Pe>=D.length){D.push(ve),xe=Pe;break}else if(D[Pe]===null){D[Pe]=ve,xe=Pe;break}if(xe===-1)break}const Re=P[xe];Re&&Re.connect(ve)}}const te=new J,oe=new J;function B($,ae,ve){te.setFromMatrixPosition(ae.matrixWorld),oe.setFromMatrixPosition(ve.matrixWorld);const xe=te.distanceTo(oe),Re=ae.projectionMatrix.elements,Pe=ve.projectionMatrix.elements,Je=Re[14]/(Re[10]-1),mt=Re[14]/(Re[10]+1),lt=(Re[9]+1)/Re[5],O=(Re[9]-1)/Re[5],nn=(Re[8]-1)/Re[0],at=(Pe[8]+1)/Pe[0],ft=Je*nn,$e=Je*at,wt=xe/(-nn+at),Ze=wt*-nn;if(ae.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(Ze),$.translateZ(wt),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Re[10]===-1)$.projectionMatrix.copy(ae.projectionMatrix),$.projectionMatrixInverse.copy(ae.projectionMatrixInverse);else{const b=Je+wt,T=mt+wt,Y=ft-Ze,fe=$e+(xe-Ze),ge=lt*mt/T*b,ce=O*mt/T*b;$.projectionMatrix.makePerspective(Y,fe,ge,ce,b,T),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function ue($,ae){ae===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(ae.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(a===null)return;let ae=$.near,ve=$.far;C.texture!==null&&(C.depthNear>0&&(ae=C.depthNear),C.depthFar>0&&(ve=C.depthFar)),E.near=q.near=U.near=ae,E.far=q.far=U.far=ve,(R!==E.near||se!==E.far)&&(a.updateRenderState({depthNear:E.near,depthFar:E.far}),R=E.near,se=E.far);const xe=$.parent,Re=E.cameras;ue(E,xe);for(let Pe=0;Pe<Re.length;Pe++)ue(Re[Pe],xe);Re.length===2?B(E,U,q):E.projectionMatrix.copy(U.projectionMatrix),re($,E,xe)};function re($,ae,ve){ve===null?$.matrix.copy(ae.matrixWorld):($.matrix.copy(ve.matrixWorld),$.matrix.invert(),$.matrix.multiply(ae.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(ae.projectionMatrix),$.projectionMatrixInverse.copy(ae.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=Yf*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return E},this.getFoveation=function(){if(!(x===null&&S===null))return p},this.setFoveation=function($){p=$,x!==null&&(x.fixedFoveation=$),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=$)},this.hasDepthSensing=function(){return C.texture!==null},this.getDepthSensingMesh=function(){return C.getMesh(E)};let N=null;function ne($,ae){if(_=ae.getViewerPose(m||f),w=ae,_!==null){const ve=_.views;S!==null&&(e.setRenderTargetFramebuffer(I,S.framebuffer),e.setRenderTarget(I));let xe=!1;ve.length!==E.cameras.length&&(E.cameras.length=0,xe=!0);for(let Pe=0;Pe<ve.length;Pe++){const Je=ve[Pe];let mt=null;if(S!==null)mt=S.getViewport(Je);else{const O=y.getViewSubImage(x,Je);mt=O.viewport,Pe===0&&(e.setRenderTargetTextures(I,O.colorTexture,x.ignoreDepthValues?void 0:O.depthStencilTexture),e.setRenderTarget(I))}let lt=Se[Pe];lt===void 0&&(lt=new Xn,lt.layers.enable(Pe),lt.viewport=new Vt,Se[Pe]=lt),lt.matrix.fromArray(Je.transform.matrix),lt.matrix.decompose(lt.position,lt.quaternion,lt.scale),lt.projectionMatrix.fromArray(Je.projectionMatrix),lt.projectionMatrixInverse.copy(lt.projectionMatrix).invert(),lt.viewport.set(mt.x,mt.y,mt.width,mt.height),Pe===0&&(E.matrix.copy(lt.matrix),E.matrix.decompose(E.position,E.quaternion,E.scale)),xe===!0&&E.cameras.push(lt)}const Re=a.enabledFeatures;if(Re&&Re.includes("depth-sensing")){const Pe=y.getDepthInformation(ve[0]);Pe&&Pe.isValid&&Pe.texture&&C.init(e,Pe,a.renderState)}}for(let ve=0;ve<P.length;ve++){const xe=D[ve],Re=P[ve];xe!==null&&Re!==void 0&&Re.update(xe,ae,m||f)}N&&N($,ae),ae.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:ae}),w=null}const Ie=new lg;Ie.setAnimationLoop(ne),this.setAnimationLoop=function($){N=$},this.dispose=function(){}}}const Br=new Bi,aE=new kt;function lE(s,e){function n(g,v){g.matrixAutoUpdate===!0&&g.updateMatrix(),v.value.copy(g.matrix)}function r(g,v){v.color.getRGB(g.fogColor.value,rg(s)),v.isFog?(g.fogNear.value=v.near,g.fogFar.value=v.far):v.isFogExp2&&(g.fogDensity.value=v.density)}function a(g,v,I,P,D){v.isMeshBasicMaterial||v.isMeshLambertMaterial?u(g,v):v.isMeshToonMaterial?(u(g,v),y(g,v)):v.isMeshPhongMaterial?(u(g,v),_(g,v)):v.isMeshStandardMaterial?(u(g,v),x(g,v),v.isMeshPhysicalMaterial&&S(g,v,D)):v.isMeshMatcapMaterial?(u(g,v),w(g,v)):v.isMeshDepthMaterial?u(g,v):v.isMeshDistanceMaterial?(u(g,v),C(g,v)):v.isMeshNormalMaterial?u(g,v):v.isLineBasicMaterial?(f(g,v),v.isLineDashedMaterial&&d(g,v)):v.isPointsMaterial?p(g,v,I,P):v.isSpriteMaterial?m(g,v):v.isShadowMaterial?(g.color.value.copy(v.color),g.opacity.value=v.opacity):v.isShaderMaterial&&(v.uniformsNeedUpdate=!1)}function u(g,v){g.opacity.value=v.opacity,v.color&&g.diffuse.value.copy(v.color),v.emissive&&g.emissive.value.copy(v.emissive).multiplyScalar(v.emissiveIntensity),v.map&&(g.map.value=v.map,n(v.map,g.mapTransform)),v.alphaMap&&(g.alphaMap.value=v.alphaMap,n(v.alphaMap,g.alphaMapTransform)),v.bumpMap&&(g.bumpMap.value=v.bumpMap,n(v.bumpMap,g.bumpMapTransform),g.bumpScale.value=v.bumpScale,v.side===Cn&&(g.bumpScale.value*=-1)),v.normalMap&&(g.normalMap.value=v.normalMap,n(v.normalMap,g.normalMapTransform),g.normalScale.value.copy(v.normalScale),v.side===Cn&&g.normalScale.value.negate()),v.displacementMap&&(g.displacementMap.value=v.displacementMap,n(v.displacementMap,g.displacementMapTransform),g.displacementScale.value=v.displacementScale,g.displacementBias.value=v.displacementBias),v.emissiveMap&&(g.emissiveMap.value=v.emissiveMap,n(v.emissiveMap,g.emissiveMapTransform)),v.specularMap&&(g.specularMap.value=v.specularMap,n(v.specularMap,g.specularMapTransform)),v.alphaTest>0&&(g.alphaTest.value=v.alphaTest);const I=e.get(v),P=I.envMap,D=I.envMapRotation;P&&(g.envMap.value=P,Br.copy(D),Br.x*=-1,Br.y*=-1,Br.z*=-1,P.isCubeTexture&&P.isRenderTargetTexture===!1&&(Br.y*=-1,Br.z*=-1),g.envMapRotation.value.setFromMatrix4(aE.makeRotationFromEuler(Br)),g.flipEnvMap.value=P.isCubeTexture&&P.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=v.reflectivity,g.ior.value=v.ior,g.refractionRatio.value=v.refractionRatio),v.lightMap&&(g.lightMap.value=v.lightMap,g.lightMapIntensity.value=v.lightMapIntensity,n(v.lightMap,g.lightMapTransform)),v.aoMap&&(g.aoMap.value=v.aoMap,g.aoMapIntensity.value=v.aoMapIntensity,n(v.aoMap,g.aoMapTransform))}function f(g,v){g.diffuse.value.copy(v.color),g.opacity.value=v.opacity,v.map&&(g.map.value=v.map,n(v.map,g.mapTransform))}function d(g,v){g.dashSize.value=v.dashSize,g.totalSize.value=v.dashSize+v.gapSize,g.scale.value=v.scale}function p(g,v,I,P){g.diffuse.value.copy(v.color),g.opacity.value=v.opacity,g.size.value=v.size*I,g.scale.value=P*.5,v.map&&(g.map.value=v.map,n(v.map,g.uvTransform)),v.alphaMap&&(g.alphaMap.value=v.alphaMap,n(v.alphaMap,g.alphaMapTransform)),v.alphaTest>0&&(g.alphaTest.value=v.alphaTest)}function m(g,v){g.diffuse.value.copy(v.color),g.opacity.value=v.opacity,g.rotation.value=v.rotation,v.map&&(g.map.value=v.map,n(v.map,g.mapTransform)),v.alphaMap&&(g.alphaMap.value=v.alphaMap,n(v.alphaMap,g.alphaMapTransform)),v.alphaTest>0&&(g.alphaTest.value=v.alphaTest)}function _(g,v){g.specular.value.copy(v.specular),g.shininess.value=Math.max(v.shininess,1e-4)}function y(g,v){v.gradientMap&&(g.gradientMap.value=v.gradientMap)}function x(g,v){g.metalness.value=v.metalness,v.metalnessMap&&(g.metalnessMap.value=v.metalnessMap,n(v.metalnessMap,g.metalnessMapTransform)),g.roughness.value=v.roughness,v.roughnessMap&&(g.roughnessMap.value=v.roughnessMap,n(v.roughnessMap,g.roughnessMapTransform)),v.envMap&&(g.envMapIntensity.value=v.envMapIntensity)}function S(g,v,I){g.ior.value=v.ior,v.sheen>0&&(g.sheenColor.value.copy(v.sheenColor).multiplyScalar(v.sheen),g.sheenRoughness.value=v.sheenRoughness,v.sheenColorMap&&(g.sheenColorMap.value=v.sheenColorMap,n(v.sheenColorMap,g.sheenColorMapTransform)),v.sheenRoughnessMap&&(g.sheenRoughnessMap.value=v.sheenRoughnessMap,n(v.sheenRoughnessMap,g.sheenRoughnessMapTransform))),v.clearcoat>0&&(g.clearcoat.value=v.clearcoat,g.clearcoatRoughness.value=v.clearcoatRoughness,v.clearcoatMap&&(g.clearcoatMap.value=v.clearcoatMap,n(v.clearcoatMap,g.clearcoatMapTransform)),v.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=v.clearcoatRoughnessMap,n(v.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),v.clearcoatNormalMap&&(g.clearcoatNormalMap.value=v.clearcoatNormalMap,n(v.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(v.clearcoatNormalScale),v.side===Cn&&g.clearcoatNormalScale.value.negate())),v.dispersion>0&&(g.dispersion.value=v.dispersion),v.iridescence>0&&(g.iridescence.value=v.iridescence,g.iridescenceIOR.value=v.iridescenceIOR,g.iridescenceThicknessMinimum.value=v.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=v.iridescenceThicknessRange[1],v.iridescenceMap&&(g.iridescenceMap.value=v.iridescenceMap,n(v.iridescenceMap,g.iridescenceMapTransform)),v.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=v.iridescenceThicknessMap,n(v.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),v.transmission>0&&(g.transmission.value=v.transmission,g.transmissionSamplerMap.value=I.texture,g.transmissionSamplerSize.value.set(I.width,I.height),v.transmissionMap&&(g.transmissionMap.value=v.transmissionMap,n(v.transmissionMap,g.transmissionMapTransform)),g.thickness.value=v.thickness,v.thicknessMap&&(g.thicknessMap.value=v.thicknessMap,n(v.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=v.attenuationDistance,g.attenuationColor.value.copy(v.attenuationColor)),v.anisotropy>0&&(g.anisotropyVector.value.set(v.anisotropy*Math.cos(v.anisotropyRotation),v.anisotropy*Math.sin(v.anisotropyRotation)),v.anisotropyMap&&(g.anisotropyMap.value=v.anisotropyMap,n(v.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=v.specularIntensity,g.specularColor.value.copy(v.specularColor),v.specularColorMap&&(g.specularColorMap.value=v.specularColorMap,n(v.specularColorMap,g.specularColorMapTransform)),v.specularIntensityMap&&(g.specularIntensityMap.value=v.specularIntensityMap,n(v.specularIntensityMap,g.specularIntensityMapTransform))}function w(g,v){v.matcap&&(g.matcap.value=v.matcap)}function C(g,v){const I=e.get(v).light;g.referencePosition.value.setFromMatrixPosition(I.matrixWorld),g.nearDistance.value=I.shadow.camera.near,g.farDistance.value=I.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:a}}function uE(s,e,n,r){let a={},u={},f=[];const d=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function p(I,P){const D=P.program;r.uniformBlockBinding(I,D)}function m(I,P){let D=a[I.id];D===void 0&&(w(I),D=_(I),a[I.id]=D,I.addEventListener("dispose",g));const j=P.program;r.updateUBOMapping(I,j);const k=e.render.frame;u[I.id]!==k&&(x(I),u[I.id]=k)}function _(I){const P=y();I.__bindingPointIndex=P;const D=s.createBuffer(),j=I.__size,k=I.usage;return s.bindBuffer(s.UNIFORM_BUFFER,D),s.bufferData(s.UNIFORM_BUFFER,j,k),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,P,D),D}function y(){for(let I=0;I<d;I++)if(f.indexOf(I)===-1)return f.push(I),I;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function x(I){const P=a[I.id],D=I.uniforms,j=I.__cache;s.bindBuffer(s.UNIFORM_BUFFER,P);for(let k=0,U=D.length;k<U;k++){const q=Array.isArray(D[k])?D[k]:[D[k]];for(let Se=0,E=q.length;Se<E;Se++){const R=q[Se];if(S(R,k,Se,j)===!0){const se=R.__offset,ee=Array.isArray(R.value)?R.value:[R.value];let le=0;for(let he=0;he<ee.length;he++){const te=ee[he],oe=C(te);typeof te=="number"||typeof te=="boolean"?(R.__data[0]=te,s.bufferSubData(s.UNIFORM_BUFFER,se+le,R.__data)):te.isMatrix3?(R.__data[0]=te.elements[0],R.__data[1]=te.elements[1],R.__data[2]=te.elements[2],R.__data[3]=0,R.__data[4]=te.elements[3],R.__data[5]=te.elements[4],R.__data[6]=te.elements[5],R.__data[7]=0,R.__data[8]=te.elements[6],R.__data[9]=te.elements[7],R.__data[10]=te.elements[8],R.__data[11]=0):(te.toArray(R.__data,le),le+=oe.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,se,R.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function S(I,P,D,j){const k=I.value,U=P+"_"+D;if(j[U]===void 0)return typeof k=="number"||typeof k=="boolean"?j[U]=k:j[U]=k.clone(),!0;{const q=j[U];if(typeof k=="number"||typeof k=="boolean"){if(q!==k)return j[U]=k,!0}else if(q.equals(k)===!1)return q.copy(k),!0}return!1}function w(I){const P=I.uniforms;let D=0;const j=16;for(let U=0,q=P.length;U<q;U++){const Se=Array.isArray(P[U])?P[U]:[P[U]];for(let E=0,R=Se.length;E<R;E++){const se=Se[E],ee=Array.isArray(se.value)?se.value:[se.value];for(let le=0,he=ee.length;le<he;le++){const te=ee[le],oe=C(te),B=D%j,ue=B%oe.boundary,re=B+ue;D+=ue,re!==0&&j-re<oe.storage&&(D+=j-re),se.__data=new Float32Array(oe.storage/Float32Array.BYTES_PER_ELEMENT),se.__offset=D,D+=oe.storage}}}const k=D%j;return k>0&&(D+=j-k),I.__size=D,I.__cache={},this}function C(I){const P={boundary:0,storage:0};return typeof I=="number"||typeof I=="boolean"?(P.boundary=4,P.storage=4):I.isVector2?(P.boundary=8,P.storage=8):I.isVector3||I.isColor?(P.boundary=16,P.storage=12):I.isVector4?(P.boundary=16,P.storage=16):I.isMatrix3?(P.boundary=48,P.storage=48):I.isMatrix4?(P.boundary=64,P.storage=64):I.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",I),P}function g(I){const P=I.target;P.removeEventListener("dispose",g);const D=f.indexOf(P.__bindingPointIndex);f.splice(D,1),s.deleteBuffer(a[P.id]),delete a[P.id],delete u[P.id]}function v(){for(const I in a)s.deleteBuffer(a[I]);f=[],a={},u={}}return{bind:p,update:m,dispose:v}}class cE{constructor(e={}){const{canvas:n=Kv(),context:r=null,depth:a=!0,stencil:u=!1,alpha:f=!1,antialias:d=!1,premultipliedAlpha:p=!0,preserveDrawingBuffer:m=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:y=!1}=e;this.isWebGLRenderer=!0;let x;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=r.getContextAttributes().alpha}else x=f;const S=new Uint32Array(4),w=new Int32Array(4);let C=null,g=null;const v=[],I=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=di,this.toneMapping=mr,this.toneMappingExposure=1;const P=this;let D=!1,j=0,k=0,U=null,q=-1,Se=null;const E=new Vt,R=new Vt;let se=null;const ee=new Et(0);let le=0,he=n.width,te=n.height,oe=1,B=null,ue=null;const re=new Vt(0,0,he,te),N=new Vt(0,0,he,te);let ne=!1;const Ie=new ag;let $=!1,ae=!1;const ve=new kt,xe=new kt,Re=new J,Pe=new Vt,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let mt=!1;function lt(){return U===null?oe:1}let O=r;function nn(A,V){return n.getContext(A,V)}try{const A={alpha:!0,depth:a,stencil:u,antialias:d,premultipliedAlpha:p,preserveDrawingBuffer:m,powerPreference:_,failIfMajorPerformanceCaveat:y};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Kf}`),n.addEventListener("webglcontextlost",de,!1),n.addEventListener("webglcontextrestored",Ae,!1),n.addEventListener("webglcontextcreationerror",De,!1),O===null){const V="webgl2";if(O=nn(V,A),O===null)throw nn(V)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw console.error("THREE.WebGLRenderer: "+A.message),A}let at,ft,$e,wt,Ze,b,T,Y,fe,ge,ce,Xe,we,Ne,dt,ye,Fe,et,Qe,Be,ut,nt,St,H;function be(){at=new mS(O),at.init(),nt=new eE(O,at),ft=new lS(O,at,e,nt),$e=new ZM(O),ft.reverseDepthBuffer&&$e.buffers.depth.setReversed(!0),wt=new vS(O),Ze=new FM,b=new JM(O,at,$e,Ze,ft,nt,wt),T=new cS(P),Y=new pS(P),fe=new T0(O),St=new oS(O,fe),ge=new gS(O,fe,wt,St),ce=new yS(O,ge,fe,wt),Qe=new xS(O,ft,b),ye=new uS(Ze),Xe=new NM(P,T,Y,at,ft,St,ye),we=new lE(P,Ze),Ne=new BM,dt=new WM(at),et=new sS(P,T,Y,$e,ce,x,p),Fe=new $M(P,ce,ft),H=new uE(O,wt,ft,$e),Be=new aS(O,at,wt),ut=new _S(O,at,wt),wt.programs=Xe.programs,P.capabilities=ft,P.extensions=at,P.properties=Ze,P.renderLists=Ne,P.shadowMap=Fe,P.state=$e,P.info=wt}be();const ie=new oE(P,O);this.xr=ie,this.getContext=function(){return O},this.getContextAttributes=function(){return O.getContextAttributes()},this.forceContextLoss=function(){const A=at.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=at.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return oe},this.setPixelRatio=function(A){A!==void 0&&(oe=A,this.setSize(he,te,!1))},this.getSize=function(A){return A.set(he,te)},this.setSize=function(A,V,K=!0){if(ie.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}he=A,te=V,n.width=Math.floor(A*oe),n.height=Math.floor(V*oe),K===!0&&(n.style.width=A+"px",n.style.height=V+"px"),this.setViewport(0,0,A,V)},this.getDrawingBufferSize=function(A){return A.set(he*oe,te*oe).floor()},this.setDrawingBufferSize=function(A,V,K){he=A,te=V,oe=K,n.width=Math.floor(A*K),n.height=Math.floor(V*K),this.setViewport(0,0,A,V)},this.getCurrentViewport=function(A){return A.copy(E)},this.getViewport=function(A){return A.copy(re)},this.setViewport=function(A,V,K,Z){A.isVector4?re.set(A.x,A.y,A.z,A.w):re.set(A,V,K,Z),$e.viewport(E.copy(re).multiplyScalar(oe).round())},this.getScissor=function(A){return A.copy(N)},this.setScissor=function(A,V,K,Z){A.isVector4?N.set(A.x,A.y,A.z,A.w):N.set(A,V,K,Z),$e.scissor(R.copy(N).multiplyScalar(oe).round())},this.getScissorTest=function(){return ne},this.setScissorTest=function(A){$e.setScissorTest(ne=A)},this.setOpaqueSort=function(A){B=A},this.setTransparentSort=function(A){ue=A},this.getClearColor=function(A){return A.copy(et.getClearColor())},this.setClearColor=function(){et.setClearColor.apply(et,arguments)},this.getClearAlpha=function(){return et.getClearAlpha()},this.setClearAlpha=function(){et.setClearAlpha.apply(et,arguments)},this.clear=function(A=!0,V=!0,K=!0){let Z=0;if(A){let G=!1;if(U!==null){const Ee=U.texture.format;G=Ee===nd||Ee===td||Ee===ed}if(G){const Ee=U.texture.type,Le=Ee===Oi||Ee===Yr||Ee===Vo||Ee===Xs||Ee===Qf||Ee===Jf,Te=et.getClearColor(),Ve=et.getClearAlpha(),je=Te.r,Ke=Te.g,Ge=Te.b;Le?(S[0]=je,S[1]=Ke,S[2]=Ge,S[3]=Ve,O.clearBufferuiv(O.COLOR,0,S)):(w[0]=je,w[1]=Ke,w[2]=Ge,w[3]=Ve,O.clearBufferiv(O.COLOR,0,w))}else Z|=O.COLOR_BUFFER_BIT}V&&(Z|=O.DEPTH_BUFFER_BIT,O.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),K&&(Z|=O.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),O.clear(Z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",de,!1),n.removeEventListener("webglcontextrestored",Ae,!1),n.removeEventListener("webglcontextcreationerror",De,!1),Ne.dispose(),dt.dispose(),Ze.dispose(),T.dispose(),Y.dispose(),ce.dispose(),St.dispose(),H.dispose(),Xe.dispose(),ie.dispose(),ie.removeEventListener("sessionstart",zi),ie.removeEventListener("sessionend",jr),Rn.stop()};function de(A){A.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),D=!0}function Ae(){console.log("THREE.WebGLRenderer: Context Restored."),D=!1;const A=wt.autoReset,V=Fe.enabled,K=Fe.autoUpdate,Z=Fe.needsUpdate,G=Fe.type;be(),wt.autoReset=A,Fe.enabled=V,Fe.autoUpdate=K,Fe.needsUpdate=Z,Fe.type=G}function De(A){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function ct(A){const V=A.target;V.removeEventListener("dispose",ct),Ft(V)}function Ft(A){rn(A),Ze.remove(A)}function rn(A){const V=Ze.get(A).programs;V!==void 0&&(V.forEach(function(K){Xe.releaseProgram(K)}),A.isShaderMaterial&&Xe.releaseShaderCache(A))}this.renderBufferDirect=function(A,V,K,Z,G,Ee){V===null&&(V=Je);const Le=G.isMesh&&G.matrixWorld.determinant()<0,Te=_i(A,V,K,Z,G);$e.setMaterial(Z,Le);let Ve=K.index,je=1;if(Z.wireframe===!0){if(Ve=ge.getWireframeAttribute(K),Ve===void 0)return;je=2}const Ke=K.drawRange,Ge=K.attributes.position;let yt=Ke.start*je,At=(Ke.start+Ke.count)*je;Ee!==null&&(yt=Math.max(yt,Ee.start*je),At=Math.min(At,(Ee.start+Ee.count)*je)),Ve!==null?(yt=Math.max(yt,0),At=Math.min(At,Ve.count)):Ge!=null&&(yt=Math.max(yt,0),At=Math.min(At,Ge.count));const Rt=At-yt;if(Rt<0||Rt===1/0)return;St.setup(G,Z,Te,K,Ve);let It,_t=Be;if(Ve!==null&&(It=fe.get(Ve),_t=ut,_t.setIndex(It)),G.isMesh)Z.wireframe===!0?($e.setLineWidth(Z.wireframeLinewidth*lt()),_t.setMode(O.LINES)):_t.setMode(O.TRIANGLES);else if(G.isLine){let Oe=Z.linewidth;Oe===void 0&&(Oe=1),$e.setLineWidth(Oe*lt()),G.isLineSegments?_t.setMode(O.LINES):G.isLineLoop?_t.setMode(O.LINE_LOOP):_t.setMode(O.LINE_STRIP)}else G.isPoints?_t.setMode(O.POINTS):G.isSprite&&_t.setMode(O.TRIANGLES);if(G.isBatchedMesh)if(G._multiDrawInstances!==null)_t.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances);else if(at.get("WEBGL_multi_draw"))_t.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const Oe=G._multiDrawStarts,Xt=G._multiDrawCounts,vt=G._multiDrawCount,Pn=Ve?fe.get(Ve).bytesPerElement:1,$n=Ze.get(Z).currentProgram.getUniforms();for(let Zt=0;Zt<vt;Zt++)$n.setValue(O,"_gl_DrawID",Zt),_t.render(Oe[Zt]/Pn,Xt[Zt])}else if(G.isInstancedMesh)_t.renderInstances(yt,Rt,G.count);else if(K.isInstancedBufferGeometry){const Oe=K._maxInstanceCount!==void 0?K._maxInstanceCount:1/0,Xt=Math.min(K.instanceCount,Oe);_t.renderInstances(yt,Rt,Xt)}else _t.render(yt,Rt)};function ht(A,V,K){A.transparent===!0&&A.side===Ui&&A.forceSinglePass===!1?(A.side=Cn,A.needsUpdate=!0,Kr(A,V,K),A.side=_r,A.needsUpdate=!0,Kr(A,V,K),A.side=Ui):Kr(A,V,K)}this.compile=function(A,V,K=null){K===null&&(K=A),g=dt.get(K),g.init(V),I.push(g),K.traverseVisible(function(G){G.isLight&&G.layers.test(V.layers)&&(g.pushLight(G),G.castShadow&&g.pushShadow(G))}),A!==K&&A.traverseVisible(function(G){G.isLight&&G.layers.test(V.layers)&&(g.pushLight(G),G.castShadow&&g.pushShadow(G))}),g.setupLights();const Z=new Set;return A.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const Ee=G.material;if(Ee)if(Array.isArray(Ee))for(let Le=0;Le<Ee.length;Le++){const Te=Ee[Le];ht(Te,K,G),Z.add(Te)}else ht(Ee,K,G),Z.add(Ee)}),I.pop(),g=null,Z},this.compileAsync=function(A,V,K=null){const Z=this.compile(A,V,K);return new Promise(G=>{function Ee(){if(Z.forEach(function(Le){Ze.get(Le).currentProgram.isReady()&&Z.delete(Le)}),Z.size===0){G(A);return}setTimeout(Ee,10)}at.get("KHR_parallel_shader_compile")!==null?Ee():setTimeout(Ee,10)})};let Kt=null;function Fn(A){Kt&&Kt(A)}function zi(){Rn.stop()}function jr(){Rn.start()}const Rn=new lg;Rn.setAnimationLoop(Fn),typeof self<"u"&&Rn.setContext(self),this.setAnimationLoop=function(A){Kt=A,ie.setAnimationLoop(A),A===null?Rn.stop():Rn.start()},ie.addEventListener("sessionstart",zi),ie.addEventListener("sessionend",jr),this.render=function(A,V){if(V!==void 0&&V.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),V.parent===null&&V.matrixWorldAutoUpdate===!0&&V.updateMatrixWorld(),ie.enabled===!0&&ie.isPresenting===!0&&(ie.cameraAutoUpdate===!0&&ie.updateCamera(V),V=ie.getCamera()),A.isScene===!0&&A.onBeforeRender(P,A,V,U),g=dt.get(A,I.length),g.init(V),I.push(g),xe.multiplyMatrices(V.projectionMatrix,V.matrixWorldInverse),Ie.setFromProjectionMatrix(xe),ae=this.localClippingEnabled,$=ye.init(this.clippingPlanes,ae),C=Ne.get(A,v.length),C.init(),v.push(C),ie.enabled===!0&&ie.isPresenting===!0){const Ee=P.xr.getDepthSensingMesh();Ee!==null&&Zs(Ee,V,-1/0,P.sortObjects)}Zs(A,V,0,P.sortObjects),C.finish(),P.sortObjects===!0&&C.sort(B,ue),mt=ie.enabled===!1||ie.isPresenting===!1||ie.hasDepthSensing()===!1,mt&&et.addToRenderList(C,A),this.info.render.frame++,$===!0&&ye.beginShadows();const K=g.state.shadowsArray;Fe.render(K,A,V),$===!0&&ye.endShadows(),this.info.autoReset===!0&&this.info.reset();const Z=C.opaque,G=C.transmissive;if(g.setupLights(),V.isArrayCamera){const Ee=V.cameras;if(G.length>0)for(let Le=0,Te=Ee.length;Le<Te;Le++){const Ve=Ee[Le];yr(Z,G,A,Ve)}mt&&et.render(A);for(let Le=0,Te=Ee.length;Le<Te;Le++){const Ve=Ee[Le];ki(C,A,Ve,Ve.viewport)}}else G.length>0&&yr(Z,G,A,V),mt&&et.render(A),ki(C,A,V);U!==null&&(b.updateMultisampleRenderTarget(U),b.updateRenderTargetMipmap(U)),A.isScene===!0&&A.onAfterRender(P,A,V),St.resetDefaultState(),q=-1,Se=null,I.pop(),I.length>0?(g=I[I.length-1],$===!0&&ye.setGlobalState(P.clippingPlanes,g.state.camera)):g=null,v.pop(),v.length>0?C=v[v.length-1]:C=null};function Zs(A,V,K,Z){if(A.visible===!1)return;if(A.layers.test(V.layers)){if(A.isGroup)K=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(V);else if(A.isLight)g.pushLight(A),A.castShadow&&g.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Ie.intersectsSprite(A)){Z&&Pe.setFromMatrixPosition(A.matrixWorld).applyMatrix4(xe);const Le=ce.update(A),Te=A.material;Te.visible&&C.push(A,Le,Te,K,Pe.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Ie.intersectsObject(A))){const Le=ce.update(A),Te=A.material;if(Z&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),Pe.copy(A.boundingSphere.center)):(Le.boundingSphere===null&&Le.computeBoundingSphere(),Pe.copy(Le.boundingSphere.center)),Pe.applyMatrix4(A.matrixWorld).applyMatrix4(xe)),Array.isArray(Te)){const Ve=Le.groups;for(let je=0,Ke=Ve.length;je<Ke;je++){const Ge=Ve[je],yt=Te[Ge.materialIndex];yt&&yt.visible&&C.push(A,Le,yt,K,Pe.z,Ge)}}else Te.visible&&C.push(A,Le,Te,K,Pe.z,null)}}const Ee=A.children;for(let Le=0,Te=Ee.length;Le<Te;Le++)Zs(Ee[Le],V,K,Z)}function ki(A,V,K,Z){const G=A.opaque,Ee=A.transmissive,Le=A.transparent;g.setupLightsView(K),$===!0&&ye.setGlobalState(P.clippingPlanes,K),Z&&$e.viewport(E.copy(Z)),G.length>0&&gi(G,V,K),Ee.length>0&&gi(Ee,V,K),Le.length>0&&gi(Le,V,K),$e.buffers.depth.setTest(!0),$e.buffers.depth.setMask(!0),$e.buffers.color.setMask(!0),$e.setPolygonOffset(!1)}function yr(A,V,K,Z){if((K.isScene===!0?K.overrideMaterial:null)!==null)return;g.state.transmissionRenderTarget[Z.id]===void 0&&(g.state.transmissionRenderTarget[Z.id]=new qr(1,1,{generateMipmaps:!0,type:at.has("EXT_color_buffer_half_float")||at.has("EXT_color_buffer_float")?Go:Oi,minFilter:Wr,samples:4,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Mt.workingColorSpace}));const Ee=g.state.transmissionRenderTarget[Z.id],Le=Z.viewport||E;Ee.setSize(Le.z,Le.w);const Te=P.getRenderTarget();P.setRenderTarget(Ee),P.getClearColor(ee),le=P.getClearAlpha(),le<1&&P.setClearColor(16777215,.5),P.clear(),mt&&et.render(K);const Ve=P.toneMapping;P.toneMapping=mr;const je=Z.viewport;if(Z.viewport!==void 0&&(Z.viewport=void 0),g.setupLightsView(Z),$===!0&&ye.setGlobalState(P.clippingPlanes,Z),gi(A,K,Z),b.updateMultisampleRenderTarget(Ee),b.updateRenderTargetMipmap(Ee),at.has("WEBGL_multisampled_render_to_texture")===!1){let Ke=!1;for(let Ge=0,yt=V.length;Ge<yt;Ge++){const At=V[Ge],Rt=At.object,It=At.geometry,_t=At.material,Oe=At.group;if(_t.side===Ui&&Rt.layers.test(Z.layers)){const Xt=_t.side;_t.side=Cn,_t.needsUpdate=!0,$r(Rt,K,Z,It,_t,Oe),_t.side=Xt,_t.needsUpdate=!0,Ke=!0}}Ke===!0&&(b.updateMultisampleRenderTarget(Ee),b.updateRenderTargetMipmap(Ee))}P.setRenderTarget(Te),P.setClearColor(ee,le),je!==void 0&&(Z.viewport=je),P.toneMapping=Ve}function gi(A,V,K){const Z=V.isScene===!0?V.overrideMaterial:null;for(let G=0,Ee=A.length;G<Ee;G++){const Le=A[G],Te=Le.object,Ve=Le.geometry,je=Z===null?Le.material:Z,Ke=Le.group;Te.layers.test(K.layers)&&$r(Te,V,K,Ve,je,Ke)}}function $r(A,V,K,Z,G,Ee){A.onBeforeRender(P,V,K,Z,G,Ee),A.modelViewMatrix.multiplyMatrices(K.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),G.onBeforeRender(P,V,K,Z,A,Ee),G.transparent===!0&&G.side===Ui&&G.forceSinglePass===!1?(G.side=Cn,G.needsUpdate=!0,P.renderBufferDirect(K,V,Z,G,A,Ee),G.side=_r,G.needsUpdate=!0,P.renderBufferDirect(K,V,Z,G,A,Ee),G.side=Ui):P.renderBufferDirect(K,V,Z,G,A,Ee),A.onAfterRender(P,V,K,Z,G,Ee)}function Kr(A,V,K){V.isScene!==!0&&(V=Je);const Z=Ze.get(A),G=g.state.lights,Ee=g.state.shadowsArray,Le=G.state.version,Te=Xe.getParameters(A,G.state,Ee,V,K),Ve=Xe.getProgramCacheKey(Te);let je=Z.programs;Z.environment=A.isMeshStandardMaterial?V.environment:null,Z.fog=V.fog,Z.envMap=(A.isMeshStandardMaterial?Y:T).get(A.envMap||Z.environment),Z.envMapRotation=Z.environment!==null&&A.envMap===null?V.environmentRotation:A.envMapRotation,je===void 0&&(A.addEventListener("dispose",ct),je=new Map,Z.programs=je);let Ke=je.get(Ve);if(Ke!==void 0){if(Z.currentProgram===Ke&&Z.lightsStateVersion===Le)return jo(A,Te),Ke}else Te.uniforms=Xe.getUniforms(A),A.onBeforeCompile(Te,P),Ke=Xe.acquireProgram(Te,Ve),je.set(Ve,Ke),Z.uniforms=Te.uniforms;const Ge=Z.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Ge.clippingPlanes=ye.uniform),jo(A,Te),Z.needsLights=Ko(A),Z.lightsStateVersion=Le,Z.needsLights&&(Ge.ambientLightColor.value=G.state.ambient,Ge.lightProbe.value=G.state.probe,Ge.directionalLights.value=G.state.directional,Ge.directionalLightShadows.value=G.state.directionalShadow,Ge.spotLights.value=G.state.spot,Ge.spotLightShadows.value=G.state.spotShadow,Ge.rectAreaLights.value=G.state.rectArea,Ge.ltc_1.value=G.state.rectAreaLTC1,Ge.ltc_2.value=G.state.rectAreaLTC2,Ge.pointLights.value=G.state.point,Ge.pointLightShadows.value=G.state.pointShadow,Ge.hemisphereLights.value=G.state.hemi,Ge.directionalShadowMap.value=G.state.directionalShadowMap,Ge.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Ge.spotShadowMap.value=G.state.spotShadowMap,Ge.spotLightMatrix.value=G.state.spotLightMatrix,Ge.spotLightMap.value=G.state.spotLightMap,Ge.pointShadowMap.value=G.state.pointShadowMap,Ge.pointShadowMatrix.value=G.state.pointShadowMatrix),Z.currentProgram=Ke,Z.uniformsList=null,Ke}function qo(A){if(A.uniformsList===null){const V=A.currentProgram.getUniforms();A.uniformsList=Ll.seqWithValue(V.seq,A.uniforms)}return A.uniformsList}function jo(A,V){const K=Ze.get(A);K.outputColorSpace=V.outputColorSpace,K.batching=V.batching,K.batchingColor=V.batchingColor,K.instancing=V.instancing,K.instancingColor=V.instancingColor,K.instancingMorph=V.instancingMorph,K.skinning=V.skinning,K.morphTargets=V.morphTargets,K.morphNormals=V.morphNormals,K.morphColors=V.morphColors,K.morphTargetsCount=V.morphTargetsCount,K.numClippingPlanes=V.numClippingPlanes,K.numIntersection=V.numClipIntersection,K.vertexAlphas=V.vertexAlphas,K.vertexTangents=V.vertexTangents,K.toneMapping=V.toneMapping}function _i(A,V,K,Z,G){V.isScene!==!0&&(V=Je),b.resetTextureUnits();const Ee=V.fog,Le=Z.isMeshStandardMaterial?V.environment:null,Te=U===null?P.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:xr,Ve=(Z.isMeshStandardMaterial?Y:T).get(Z.envMap||Le),je=Z.vertexColors===!0&&!!K.attributes.color&&K.attributes.color.itemSize===4,Ke=!!K.attributes.tangent&&(!!Z.normalMap||Z.anisotropy>0),Ge=!!K.morphAttributes.position,yt=!!K.morphAttributes.normal,At=!!K.morphAttributes.color;let Rt=mr;Z.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(Rt=P.toneMapping);const It=K.morphAttributes.position||K.morphAttributes.normal||K.morphAttributes.color,_t=It!==void 0?It.length:0,Oe=Ze.get(Z),Xt=g.state.lights;if($===!0&&(ae===!0||A!==Se)){const an=A===Se&&Z.id===q;ye.setState(Z,A,an)}let vt=!1;Z.version===Oe.__version?(Oe.needsLights&&Oe.lightsStateVersion!==Xt.state.version||Oe.outputColorSpace!==Te||G.isBatchedMesh&&Oe.batching===!1||!G.isBatchedMesh&&Oe.batching===!0||G.isBatchedMesh&&Oe.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&Oe.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&Oe.instancing===!1||!G.isInstancedMesh&&Oe.instancing===!0||G.isSkinnedMesh&&Oe.skinning===!1||!G.isSkinnedMesh&&Oe.skinning===!0||G.isInstancedMesh&&Oe.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Oe.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Oe.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Oe.instancingMorph===!1&&G.morphTexture!==null||Oe.envMap!==Ve||Z.fog===!0&&Oe.fog!==Ee||Oe.numClippingPlanes!==void 0&&(Oe.numClippingPlanes!==ye.numPlanes||Oe.numIntersection!==ye.numIntersection)||Oe.vertexAlphas!==je||Oe.vertexTangents!==Ke||Oe.morphTargets!==Ge||Oe.morphNormals!==yt||Oe.morphColors!==At||Oe.toneMapping!==Rt||Oe.morphTargetsCount!==_t)&&(vt=!0):(vt=!0,Oe.__version=Z.version);let Pn=Oe.currentProgram;vt===!0&&(Pn=Kr(Z,V,G));let $n=!1,Zt=!1,vi=!1;const Pt=Pn.getUniforms(),ai=Oe.uniforms;if($e.useProgram(Pn.program)&&($n=!0,Zt=!0,vi=!0),Z.id!==q&&(q=Z.id,Zt=!0),$n||Se!==A){ft.reverseDepthBuffer?(ve.copy(A.projectionMatrix),Qv(ve),Jv(ve),Pt.setValue(O,"projectionMatrix",ve)):Pt.setValue(O,"projectionMatrix",A.projectionMatrix),Pt.setValue(O,"viewMatrix",A.matrixWorldInverse);const an=Pt.map.cameraPosition;an!==void 0&&an.setValue(O,Re.setFromMatrixPosition(A.matrixWorld)),ft.logarithmicDepthBuffer&&Pt.setValue(O,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(Z.isMeshPhongMaterial||Z.isMeshToonMaterial||Z.isMeshLambertMaterial||Z.isMeshBasicMaterial||Z.isMeshStandardMaterial||Z.isShaderMaterial)&&Pt.setValue(O,"isOrthographic",A.isOrthographicCamera===!0),Se!==A&&(Se=A,Zt=!0,vi=!0)}if(G.isSkinnedMesh){Pt.setOptional(O,G,"bindMatrix"),Pt.setOptional(O,G,"bindMatrixInverse");const an=G.skeleton;an&&(an.boneTexture===null&&an.computeBoneTexture(),Pt.setValue(O,"boneTexture",an.boneTexture,b))}G.isBatchedMesh&&(Pt.setOptional(O,G,"batchingTexture"),Pt.setValue(O,"batchingTexture",G._matricesTexture,b),Pt.setOptional(O,G,"batchingIdTexture"),Pt.setValue(O,"batchingIdTexture",G._indirectTexture,b),Pt.setOptional(O,G,"batchingColorTexture"),G._colorsTexture!==null&&Pt.setValue(O,"batchingColorTexture",G._colorsTexture,b));const Qs=K.morphAttributes;if((Qs.position!==void 0||Qs.normal!==void 0||Qs.color!==void 0)&&Qe.update(G,K,Pn),(Zt||Oe.receiveShadow!==G.receiveShadow)&&(Oe.receiveShadow=G.receiveShadow,Pt.setValue(O,"receiveShadow",G.receiveShadow)),Z.isMeshGouraudMaterial&&Z.envMap!==null&&(ai.envMap.value=Ve,ai.flipEnvMap.value=Ve.isCubeTexture&&Ve.isRenderTargetTexture===!1?-1:1),Z.isMeshStandardMaterial&&Z.envMap===null&&V.environment!==null&&(ai.envMapIntensity.value=V.environmentIntensity),Zt&&(Pt.setValue(O,"toneMappingExposure",P.toneMappingExposure),Oe.needsLights&&$o(ai,vi),Ee&&Z.fog===!0&&we.refreshFogUniforms(ai,Ee),we.refreshMaterialUniforms(ai,Z,oe,te,g.state.transmissionRenderTarget[A.id]),Ll.upload(O,qo(Oe),ai,b)),Z.isShaderMaterial&&Z.uniformsNeedUpdate===!0&&(Ll.upload(O,qo(Oe),ai,b),Z.uniformsNeedUpdate=!1),Z.isSpriteMaterial&&Pt.setValue(O,"center",G.center),Pt.setValue(O,"modelViewMatrix",G.modelViewMatrix),Pt.setValue(O,"normalMatrix",G.normalMatrix),Pt.setValue(O,"modelMatrix",G.matrixWorld),Z.isShaderMaterial||Z.isRawShaderMaterial){const an=Z.uniformsGroups;for(let Zr=0,Js=an.length;Zr<Js;Zr++){const Hi=an[Zr];H.update(Hi,Pn),H.bind(Hi,Pn)}}return Pn}function $o(A,V){A.ambientLightColor.needsUpdate=V,A.lightProbe.needsUpdate=V,A.directionalLights.needsUpdate=V,A.directionalLightShadows.needsUpdate=V,A.pointLights.needsUpdate=V,A.pointLightShadows.needsUpdate=V,A.spotLights.needsUpdate=V,A.spotLightShadows.needsUpdate=V,A.rectAreaLights.needsUpdate=V,A.hemisphereLights.needsUpdate=V}function Ko(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return j},this.getActiveMipmapLevel=function(){return k},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(A,V,K){Ze.get(A.texture).__webglTexture=V,Ze.get(A.depthTexture).__webglTexture=K;const Z=Ze.get(A);Z.__hasExternalTextures=!0,Z.__autoAllocateDepthBuffer=K===void 0,Z.__autoAllocateDepthBuffer||at.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),Z.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(A,V){const K=Ze.get(A);K.__webglFramebuffer=V,K.__useDefaultFramebuffer=V===void 0},this.setRenderTarget=function(A,V=0,K=0){U=A,j=V,k=K;let Z=!0,G=null,Ee=!1,Le=!1;if(A){const Ve=Ze.get(A);if(Ve.__useDefaultFramebuffer!==void 0)$e.bindFramebuffer(O.FRAMEBUFFER,null),Z=!1;else if(Ve.__webglFramebuffer===void 0)b.setupRenderTarget(A);else if(Ve.__hasExternalTextures)b.rebindTextures(A,Ze.get(A.texture).__webglTexture,Ze.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Ge=A.depthTexture;if(Ve.__boundDepthTexture!==Ge){if(Ge!==null&&Ze.has(Ge)&&(A.width!==Ge.image.width||A.height!==Ge.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");b.setupDepthRenderbuffer(A)}}const je=A.texture;(je.isData3DTexture||je.isDataArrayTexture||je.isCompressedArrayTexture)&&(Le=!0);const Ke=Ze.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Ke[V])?G=Ke[V][K]:G=Ke[V],Ee=!0):A.samples>0&&b.useMultisampledRTT(A)===!1?G=Ze.get(A).__webglMultisampledFramebuffer:Array.isArray(Ke)?G=Ke[K]:G=Ke,E.copy(A.viewport),R.copy(A.scissor),se=A.scissorTest}else E.copy(re).multiplyScalar(oe).floor(),R.copy(N).multiplyScalar(oe).floor(),se=ne;if($e.bindFramebuffer(O.FRAMEBUFFER,G)&&Z&&$e.drawBuffers(A,G),$e.viewport(E),$e.scissor(R),$e.setScissorTest(se),Ee){const Ve=Ze.get(A.texture);O.framebufferTexture2D(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_CUBE_MAP_POSITIVE_X+V,Ve.__webglTexture,K)}else if(Le){const Ve=Ze.get(A.texture),je=V||0;O.framebufferTextureLayer(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,Ve.__webglTexture,K||0,je)}q=-1},this.readRenderTargetPixels=function(A,V,K,Z,G,Ee,Le){if(!(A&&A.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Te=Ze.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Le!==void 0&&(Te=Te[Le]),Te){$e.bindFramebuffer(O.FRAMEBUFFER,Te);try{const Ve=A.texture,je=Ve.format,Ke=Ve.type;if(!ft.textureFormatReadable(je)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ft.textureTypeReadable(Ke)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}V>=0&&V<=A.width-Z&&K>=0&&K<=A.height-G&&O.readPixels(V,K,Z,G,nt.convert(je),nt.convert(Ke),Ee)}finally{const Ve=U!==null?Ze.get(U).__webglFramebuffer:null;$e.bindFramebuffer(O.FRAMEBUFFER,Ve)}}},this.readRenderTargetPixelsAsync=async function(A,V,K,Z,G,Ee,Le){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Te=Ze.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Le!==void 0&&(Te=Te[Le]),Te){const Ve=A.texture,je=Ve.format,Ke=Ve.type;if(!ft.textureFormatReadable(je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ft.textureTypeReadable(Ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(V>=0&&V<=A.width-Z&&K>=0&&K<=A.height-G){$e.bindFramebuffer(O.FRAMEBUFFER,Te);const Ge=O.createBuffer();O.bindBuffer(O.PIXEL_PACK_BUFFER,Ge),O.bufferData(O.PIXEL_PACK_BUFFER,Ee.byteLength,O.STREAM_READ),O.readPixels(V,K,Z,G,nt.convert(je),nt.convert(Ke),0);const yt=U!==null?Ze.get(U).__webglFramebuffer:null;$e.bindFramebuffer(O.FRAMEBUFFER,yt);const At=O.fenceSync(O.SYNC_GPU_COMMANDS_COMPLETE,0);return O.flush(),await Zv(O,At,4),O.bindBuffer(O.PIXEL_PACK_BUFFER,Ge),O.getBufferSubData(O.PIXEL_PACK_BUFFER,0,Ee),O.deleteBuffer(Ge),O.deleteSync(At),Ee}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(A,V=null,K=0){A.isTexture!==!0&&(bl("WebGLRenderer: copyFramebufferToTexture function signature has changed."),V=arguments[0]||null,A=arguments[1]);const Z=Math.pow(2,-K),G=Math.floor(A.image.width*Z),Ee=Math.floor(A.image.height*Z),Le=V!==null?V.x:0,Te=V!==null?V.y:0;b.setTexture2D(A,0),O.copyTexSubImage2D(O.TEXTURE_2D,K,0,0,Le,Te,G,Ee),$e.unbindTexture()},this.copyTextureToTexture=function(A,V,K=null,Z=null,G=0){A.isTexture!==!0&&(bl("WebGLRenderer: copyTextureToTexture function signature has changed."),Z=arguments[0]||null,A=arguments[1],V=arguments[2],G=arguments[3]||0,K=null);let Ee,Le,Te,Ve,je,Ke;K!==null?(Ee=K.max.x-K.min.x,Le=K.max.y-K.min.y,Te=K.min.x,Ve=K.min.y):(Ee=A.image.width,Le=A.image.height,Te=0,Ve=0),Z!==null?(je=Z.x,Ke=Z.y):(je=0,Ke=0);const Ge=nt.convert(V.format),yt=nt.convert(V.type);b.setTexture2D(V,0),O.pixelStorei(O.UNPACK_FLIP_Y_WEBGL,V.flipY),O.pixelStorei(O.UNPACK_PREMULTIPLY_ALPHA_WEBGL,V.premultiplyAlpha),O.pixelStorei(O.UNPACK_ALIGNMENT,V.unpackAlignment);const At=O.getParameter(O.UNPACK_ROW_LENGTH),Rt=O.getParameter(O.UNPACK_IMAGE_HEIGHT),It=O.getParameter(O.UNPACK_SKIP_PIXELS),_t=O.getParameter(O.UNPACK_SKIP_ROWS),Oe=O.getParameter(O.UNPACK_SKIP_IMAGES),Xt=A.isCompressedTexture?A.mipmaps[G]:A.image;O.pixelStorei(O.UNPACK_ROW_LENGTH,Xt.width),O.pixelStorei(O.UNPACK_IMAGE_HEIGHT,Xt.height),O.pixelStorei(O.UNPACK_SKIP_PIXELS,Te),O.pixelStorei(O.UNPACK_SKIP_ROWS,Ve),A.isDataTexture?O.texSubImage2D(O.TEXTURE_2D,G,je,Ke,Ee,Le,Ge,yt,Xt.data):A.isCompressedTexture?O.compressedTexSubImage2D(O.TEXTURE_2D,G,je,Ke,Xt.width,Xt.height,Ge,Xt.data):O.texSubImage2D(O.TEXTURE_2D,G,je,Ke,Ee,Le,Ge,yt,Xt),O.pixelStorei(O.UNPACK_ROW_LENGTH,At),O.pixelStorei(O.UNPACK_IMAGE_HEIGHT,Rt),O.pixelStorei(O.UNPACK_SKIP_PIXELS,It),O.pixelStorei(O.UNPACK_SKIP_ROWS,_t),O.pixelStorei(O.UNPACK_SKIP_IMAGES,Oe),G===0&&V.generateMipmaps&&O.generateMipmap(O.TEXTURE_2D),$e.unbindTexture()},this.copyTextureToTexture3D=function(A,V,K=null,Z=null,G=0){A.isTexture!==!0&&(bl("WebGLRenderer: copyTextureToTexture3D function signature has changed."),K=arguments[0]||null,Z=arguments[1]||null,A=arguments[2],V=arguments[3],G=arguments[4]||0);let Ee,Le,Te,Ve,je,Ke,Ge,yt,At;const Rt=A.isCompressedTexture?A.mipmaps[G]:A.image;K!==null?(Ee=K.max.x-K.min.x,Le=K.max.y-K.min.y,Te=K.max.z-K.min.z,Ve=K.min.x,je=K.min.y,Ke=K.min.z):(Ee=Rt.width,Le=Rt.height,Te=Rt.depth,Ve=0,je=0,Ke=0),Z!==null?(Ge=Z.x,yt=Z.y,At=Z.z):(Ge=0,yt=0,At=0);const It=nt.convert(V.format),_t=nt.convert(V.type);let Oe;if(V.isData3DTexture)b.setTexture3D(V,0),Oe=O.TEXTURE_3D;else if(V.isDataArrayTexture||V.isCompressedArrayTexture)b.setTexture2DArray(V,0),Oe=O.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}O.pixelStorei(O.UNPACK_FLIP_Y_WEBGL,V.flipY),O.pixelStorei(O.UNPACK_PREMULTIPLY_ALPHA_WEBGL,V.premultiplyAlpha),O.pixelStorei(O.UNPACK_ALIGNMENT,V.unpackAlignment);const Xt=O.getParameter(O.UNPACK_ROW_LENGTH),vt=O.getParameter(O.UNPACK_IMAGE_HEIGHT),Pn=O.getParameter(O.UNPACK_SKIP_PIXELS),$n=O.getParameter(O.UNPACK_SKIP_ROWS),Zt=O.getParameter(O.UNPACK_SKIP_IMAGES);O.pixelStorei(O.UNPACK_ROW_LENGTH,Rt.width),O.pixelStorei(O.UNPACK_IMAGE_HEIGHT,Rt.height),O.pixelStorei(O.UNPACK_SKIP_PIXELS,Ve),O.pixelStorei(O.UNPACK_SKIP_ROWS,je),O.pixelStorei(O.UNPACK_SKIP_IMAGES,Ke),A.isDataTexture||A.isData3DTexture?O.texSubImage3D(Oe,G,Ge,yt,At,Ee,Le,Te,It,_t,Rt.data):V.isCompressedArrayTexture?O.compressedTexSubImage3D(Oe,G,Ge,yt,At,Ee,Le,Te,It,Rt.data):O.texSubImage3D(Oe,G,Ge,yt,At,Ee,Le,Te,It,_t,Rt),O.pixelStorei(O.UNPACK_ROW_LENGTH,Xt),O.pixelStorei(O.UNPACK_IMAGE_HEIGHT,vt),O.pixelStorei(O.UNPACK_SKIP_PIXELS,Pn),O.pixelStorei(O.UNPACK_SKIP_ROWS,$n),O.pixelStorei(O.UNPACK_SKIP_IMAGES,Zt),G===0&&V.generateMipmaps&&O.generateMipmap(Oe),$e.unbindTexture()},this.initRenderTarget=function(A){Ze.get(A).__webglFramebuffer===void 0&&b.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?b.setTextureCube(A,0):A.isData3DTexture?b.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?b.setTexture2DArray(A,0):b.setTexture2D(A,0),$e.unbindTexture()},this.resetState=function(){j=0,k=0,U=null,$e.reset(),St.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ni}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===id?"display-p3":"srgb",n.unpackColorSpace=Mt.workingColorSpace===zl?"display-p3":"srgb"}}class fE extends xn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Bi,this.environmentIntensity=1,this.environmentRotation=new Bi,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class dE{constructor(e,n){this.isInterleavedBuffer=!0,this.array=e,this.stride=n,this.count=e!==void 0?e.length/n:0,this.usage=Xf,this.updateRanges=[],this.version=0,this.uuid=gr()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}setUsage(e){return this.usage=e,this}addUpdateRange(e,n){this.updateRanges.push({start:e,count:n})}clearUpdateRanges(){this.updateRanges.length=0}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,n,r){e*=this.stride,r*=n.stride;for(let a=0,u=this.stride;a<u;a++)this.array[e+a]=n.array[r+a];return this}set(e,n=0){return this.array.set(e,n),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=gr()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const n=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),r=new this.constructor(n,this.stride);return r.setUsage(this.usage),r}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=gr()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const gn=new J;class Ol{constructor(e,n,r,a=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=n,this.offset=r,this.normalized=a}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let n=0,r=this.data.count;n<r;n++)gn.fromBufferAttribute(this,n),gn.applyMatrix4(e),this.setXYZ(n,gn.x,gn.y,gn.z);return this}applyNormalMatrix(e){for(let n=0,r=this.count;n<r;n++)gn.fromBufferAttribute(this,n),gn.applyNormalMatrix(e),this.setXYZ(n,gn.x,gn.y,gn.z);return this}transformDirection(e){for(let n=0,r=this.count;n<r;n++)gn.fromBufferAttribute(this,n),gn.transformDirection(e),this.setXYZ(n,gn.x,gn.y,gn.z);return this}getComponent(e,n){let r=this.array[e*this.data.stride+this.offset+n];return this.normalized&&(r=pi(r,this.array)),r}setComponent(e,n,r){return this.normalized&&(r=Ct(r,this.array)),this.data.array[e*this.data.stride+this.offset+n]=r,this}setX(e,n){return this.normalized&&(n=Ct(n,this.array)),this.data.array[e*this.data.stride+this.offset]=n,this}setY(e,n){return this.normalized&&(n=Ct(n,this.array)),this.data.array[e*this.data.stride+this.offset+1]=n,this}setZ(e,n){return this.normalized&&(n=Ct(n,this.array)),this.data.array[e*this.data.stride+this.offset+2]=n,this}setW(e,n){return this.normalized&&(n=Ct(n,this.array)),this.data.array[e*this.data.stride+this.offset+3]=n,this}getX(e){let n=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(n=pi(n,this.array)),n}getY(e){let n=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(n=pi(n,this.array)),n}getZ(e){let n=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(n=pi(n,this.array)),n}getW(e){let n=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(n=pi(n,this.array)),n}setXY(e,n,r){return e=e*this.data.stride+this.offset,this.normalized&&(n=Ct(n,this.array),r=Ct(r,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=r,this}setXYZ(e,n,r,a){return e=e*this.data.stride+this.offset,this.normalized&&(n=Ct(n,this.array),r=Ct(r,this.array),a=Ct(a,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=r,this.data.array[e+2]=a,this}setXYZW(e,n,r,a,u){return e=e*this.data.stride+this.offset,this.normalized&&(n=Ct(n,this.array),r=Ct(r,this.array),a=Ct(a,this.array),u=Ct(u,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=r,this.data.array[e+2]=a,this.data.array[e+3]=u,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let r=0;r<this.count;r++){const a=r*this.data.stride+this.offset;for(let u=0;u<this.itemSize;u++)n.push(this.data.array[a+u])}return new jn(new this.array.constructor(n),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new Ol(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let r=0;r<this.count;r++){const a=r*this.data.stride+this.offset;for(let u=0;u<this.itemSize;u++)n.push(this.data.array[a+u])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:n,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class pg extends $s{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Et(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let Is;const Bo=new J,Ns=new J,Fs=new J,Os=new pt,zo=new pt,mg=new kt,yl=new J,ko=new J,Sl=new J,Rm=new pt,nf=new pt,Pm=new pt;class hE extends xn{constructor(e=new pg){if(super(),this.isSprite=!0,this.type="Sprite",Is===void 0){Is=new mi;const n=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),r=new dE(n,5);Is.setIndex([0,1,2,0,2,3]),Is.setAttribute("position",new Ol(r,3,0,!1)),Is.setAttribute("uv",new Ol(r,2,3,!1))}this.geometry=Is,this.material=e,this.center=new pt(.5,.5)}raycast(e,n){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),Ns.setFromMatrixScale(this.matrixWorld),mg.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),Fs.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&Ns.multiplyScalar(-Fs.z);const r=this.material.rotation;let a,u;r!==0&&(u=Math.cos(r),a=Math.sin(r));const f=this.center;Ml(yl.set(-.5,-.5,0),Fs,f,Ns,a,u),Ml(ko.set(.5,-.5,0),Fs,f,Ns,a,u),Ml(Sl.set(.5,.5,0),Fs,f,Ns,a,u),Rm.set(0,0),nf.set(1,0),Pm.set(1,1);let d=e.ray.intersectTriangle(yl,ko,Sl,!1,Bo);if(d===null&&(Ml(ko.set(-.5,.5,0),Fs,f,Ns,a,u),nf.set(0,1),d=e.ray.intersectTriangle(yl,Sl,ko,!1,Bo),d===null))return;const p=e.ray.origin.distanceTo(Bo);p<e.near||p>e.far||n.push({distance:p,point:Bo.clone(),uv:Yn.getInterpolation(Bo,yl,ko,Sl,Rm,nf,Pm,new pt),face:null,object:this})}copy(e,n){return super.copy(e,n),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function Ml(s,e,n,r,a,u){Os.subVectors(s,n).addScalar(.5).multiply(r),a!==void 0?(zo.x=u*Os.x-a*Os.y,zo.y=a*Os.x+u*Os.y):zo.copy(Os),s.copy(e),s.x+=zo.x,s.y+=zo.y,s.applyMatrix4(mg)}class gg extends $s{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Et(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const bm=new kt,jf=new Qm,El=new kl,Tl=new J;class pE extends xn{constructor(e=new mi,n=new gg){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,n){const r=this.geometry,a=this.matrixWorld,u=e.params.Points.threshold,f=r.drawRange;if(r.boundingSphere===null&&r.computeBoundingSphere(),El.copy(r.boundingSphere),El.applyMatrix4(a),El.radius+=u,e.ray.intersectsSphere(El)===!1)return;bm.copy(a).invert(),jf.copy(e.ray).applyMatrix4(bm);const d=u/((this.scale.x+this.scale.y+this.scale.z)/3),p=d*d,m=r.index,y=r.attributes.position;if(m!==null){const x=Math.max(0,f.start),S=Math.min(m.count,f.start+f.count);for(let w=x,C=S;w<C;w++){const g=m.getX(w);Tl.fromBufferAttribute(y,g),Lm(Tl,g,p,a,e,n,this)}}else{const x=Math.max(0,f.start),S=Math.min(y.count,f.start+f.count);for(let w=x,C=S;w<C;w++)Tl.fromBufferAttribute(y,w),Lm(Tl,w,p,a,e,n,this)}}updateMorphTargets(){const n=this.geometry.morphAttributes,r=Object.keys(n);if(r.length>0){const a=n[r[0]];if(a!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let u=0,f=a.length;u<f;u++){const d=a[u].name||String(u);this.morphTargetInfluences.push(0),this.morphTargetDictionary[d]=u}}}}}function Lm(s,e,n,r,a,u,f){const d=jf.distanceSqToPoint(s);if(d<n){const p=new J;jf.closestPointToPoint(s,p),p.applyMatrix4(r);const m=a.ray.origin.distanceTo(p);if(m<a.near||m>a.far)return;u.push({distance:m,distanceToRay:Math.sqrt(d),point:p,index:e,face:null,faceIndex:null,barycoord:null,object:f})}}class mE extends vn{constructor(e,n,r,a,u,f,d,p,m){super(e,n,r,a,u,f,d,p,m),this.isCanvasTexture=!0,this.needsUpdate=!0}}class gE{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Dm(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const n=Dm();e=(n-this.oldTime)/1e3,this.oldTime=n,this.elapsedTime+=e}return e}}function Dm(){return performance.now()}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Kf}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Kf);function _E(){const s=Wn.useRef(null);return Wn.useEffect(()=>{const e=s.current;if(!e)return;const n=window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=new fE,a=new Xn(55,window.innerWidth/window.innerHeight,.1,120);a.position.z=14;const u=new cE({alpha:!0,antialias:!0});u.setSize(window.innerWidth,window.innerHeight),u.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.appendChild(u.domElement);const f=(P,D)=>{const j=document.createElement("canvas");j.width=256,j.height=256;const k=j.getContext("2d"),U=k.createRadialGradient(128,128,0,128,128,128);return U.addColorStop(0,P),U.addColorStop(.45,D),U.addColorStop(1,"rgba(0,0,0,0)"),k.fillStyle=U,k.fillRect(0,0,256,256),new mE(j)},p=[{x:-7,y:3.5,z:-12,s:26,tex:f("rgba(255,45,85,0.55)","rgba(120,10,40,0.22)")},{x:8,y:-2,z:-16,s:30,tex:f("rgba(157,0,255,0.34)","rgba(60,0,110,0.16)")},{x:5,y:5,z:-20,s:24,tex:f("rgba(0,229,255,0.30)","rgba(0,70,110,0.14)")},{x:-3,y:-5,z:-10,s:20,tex:f("rgba(255,140,60,0.20)","rgba(120,50,10,0.10)")}].map(P=>{const D=new hE(new pg({map:P.tex,transparent:!0,depthWrite:!1,blending:sf}));return D.position.set(P.x,P.y,P.z),D.scale.set(P.s,P.s,1),r.add(D),D}),m=1400,_=new Float32Array(m*3);for(let P=0;P<m;P+=1)_[P*3]=(Math.random()-.5)*70,_[P*3+1]=(Math.random()-.5)*40,_[P*3+2]=(Math.random()-.5)*50-10;const y=new mi;y.setAttribute("position",new jn(_,3));const x=new pE(y,new gg({color:14674175,size:.09,transparent:!0,opacity:.85,sizeAttenuation:!0}));r.add(x);const S={x:0,y:0},w=P=>{S.x=(P.clientX/window.innerWidth-.5)*1.4,S.y=-(P.clientY/window.innerHeight-.5)*.9};window.addEventListener("mousemove",w);let C=0;const g=new gE,v=()=>{const P=g.getElapsedTime();x.rotation.y=P*.008,p.forEach((D,j)=>{D.position.x+=Math.sin(P*.05+j*1.7)*.002,D.material.rotation=P*.01*(j%2?1:-1)}),a.position.x+=(S.x-a.position.x)*.04,a.position.y+=(S.y-a.position.y)*.04,a.lookAt(0,0,-6),u.render(r,a)};if(n)v();else{const P=()=>{v(),C=requestAnimationFrame(P)};P()}const I=()=>{a.aspect=window.innerWidth/window.innerHeight,a.updateProjectionMatrix(),u.setSize(window.innerWidth,window.innerHeight)};return window.addEventListener("resize",I),()=>{cancelAnimationFrame(C),window.removeEventListener("resize",I),window.removeEventListener("mousemove",w),u.dispose(),y.dispose(),p.forEach(P=>{P.material.map.dispose(),P.material.dispose()}),u.domElement.parentNode===e&&e.removeChild(u.domElement)}},[]),it.jsx("div",{className:"cosmic-scene",ref:s,"aria-hidden":"true"})}const rf=10,Um=[{id:"genesis",num:"I",title:"Génesis",text:"Todo imperio empieza en un vacío. Belentani compila su caos — eras, gemas, elementos — y lo convierte en sistema. La Judas Experience nace como respuesta: si el mundo te etiqueta, haz del mito tu arquitectura."},{id:"traicion",num:"II",title:"Traición",text:"La traición como arte supremo. No como herida, sino como material: cada traición vivida se compila en obra. Aquí el artista decide que nada se pierde — todo se transforma."},{id:"beso",num:"III",title:"El Beso",text:"El acto más íntimo y más público. La voz clonada, el mirror del yo, el contacto entre el artista y su multitud. En el vacío interestelar, donde la luz se curva, un beso dobla el tiempo."},{id:"redencion",num:"IV",title:"Redención",text:"Educación abierta en PT · ES · EN · CA. Conocimiento sin barreras, sin registro, sin vigilancia: la redención no se predica, se comparte. Este portal es la prueba."}];function Im(s){return(s||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function vE({ch:s,onOpen:e}){const n=Wn.useRef(null),[r,a]=Wn.useState(!1);return Wn.useEffect(()=>{const u=n.current;if(!u)return;const f=new IntersectionObserver(([d])=>{d.isIntersecting&&(a(!0),f.disconnect())},{threshold:.25});return f.observe(u),()=>f.disconnect()},[]),it.jsxs("article",{ref:n,className:`chapter ${r?"is-visible":""}`,id:s.id,children:[it.jsx("div",{className:"ch-num","aria-hidden":"true",children:s.num}),it.jsx("h2",{className:"ch-title",children:s.title}),it.jsx("p",{className:"ch-text",children:s.text}),s.id==="redencion"&&it.jsx("button",{type:"button",className:"btn-neon",onClick:e,children:"Entrar en la Biblioteca ↓"})]})}function xE(){const[s,e]=Wn.useState([]),[n,r]=Wn.useState("Invocando la biblioteca…"),[a,u]=Wn.useState(""),[f,d]=Wn.useState(1);Wn.useEffect(()=>{let S=!0;return fetch("search-index.json").then(w=>w.json()).then(w=>{S&&(e(w.pages||[]),r(`${(w.pages||[]).length} documentos públicos`))}).catch(()=>r("Índice no disponible. Ejecuta scripts/build_portal.py --copy.")),()=>{S=!1}},[]);const p=Wn.useMemo(()=>{const S=Im(a.trim());if(!S)return s;const w=S.split(/\s+/);return s.filter(C=>{const g=Im(`${C.title} ${C.path}`);return w.every(v=>g.includes(v))})},[s,a]),m=Math.max(1,Math.ceil(p.length/rf)),_=f>m?1:f,y=p.slice((_-1)*rf,_*rf),x=()=>{var S;(S=document.getElementById("biblioteca"))==null||S.scrollIntoView({behavior:"smooth"})};return it.jsxs("div",{className:"portal",children:[it.jsx("div",{className:"grain","aria-hidden":"true"}),it.jsx("div",{className:"cosmos","aria-hidden":"true",children:it.jsx(_E,{})}),it.jsxs("nav",{className:"nav","aria-label":"Navegación principal",children:[it.jsxs("a",{className:"brand",href:"#top",children:[it.jsx("span",{className:"cross",children:"✝"})," JUDAS"]}),it.jsxs("div",{className:"links",children:[Um.map(S=>it.jsx("a",{href:`#${S.id}`,children:S.title},S.id)),it.jsx("a",{href:"#biblioteca",children:"Biblioteca"}),it.jsx("a",{href:"https://github.com/belentani7",target:"_blank",rel:"noreferrer",children:"GitHub"})]})]}),it.jsxs("header",{className:"hero",id:"top",children:[it.jsx("h1",{className:"hero-title",children:"JUDAS"}),it.jsx("p",{className:"hero-sub",children:"BELentani · galactic experience"}),it.jsx("p",{className:"hero-motto",children:"La traición como arte supremo"}),it.jsx("p",{className:"hero-quote",children:"«En el vacío interestelar, donde la luz se curva y el tiempo se pliega, existe una galaxia llamada Belentani.»"})]}),it.jsxs("main",{children:[it.jsx("div",{className:"chapters",children:Um.map(S=>it.jsx(vE,{ch:S,onOpen:x},S.id))}),it.jsxs("section",{className:"library",id:"biblioteca",children:[it.jsx("h2",{className:"lib-title",children:"La Biblioteca"}),it.jsx("p",{className:"lib-sub",children:"790 documentos públicos del universo Belentani · Judas Experience — eras, obra, lore, interfaces y experiencias compiladas."}),it.jsx("input",{className:"search",type:"search",value:a,placeholder:"Buscar en la biblioteca… (p. ej. «Judas Era», «Omega»)","aria-label":"Buscar en la biblioteca",onChange:S=>{u(S.target.value),d(1)}}),it.jsxs("p",{className:"status",role:"status",children:[n,a&&` · ${p.length} resultados`]}),it.jsx("div",{className:"results",children:y.map(S=>it.jsxs("a",{className:"result",href:`html-source/${encodeURIComponent(S.path)}`,children:[it.jsx("span",{className:"r-title",children:S.title}),it.jsx("span",{className:"r-path",children:S.path})]},S.path))}),it.jsx("div",{className:"pager",role:"navigation","aria-label":"Paginación",children:Array.from({length:Math.min(7,m)},(S,w)=>Math.max(1,Math.min(_-3,m-6))+w).filter(S=>S>=1&&S<=m).map(S=>it.jsx("button",{type:"button","aria-current":S===_,onClick:()=>{var w;d(S),window.scrollTo({top:((w=document.getElementById("biblioteca"))==null?void 0:w.offsetTop)-40})},children:S},S))})]})]}),it.jsxs("footer",{children:[it.jsx("p",{className:"f-cross",children:"✝"}),it.jsx("p",{children:"© 2026 Belentani · Judas Experience"}),it.jsx("p",{className:"hz",children:"432 Hz · NOIACORE · L'Hospitalet de Llobregat"}),it.jsx("p",{children:it.jsx("a",{href:"https://github.com/belentani7",children:"github.com/belentani7"})})]})]})}ov.createRoot(document.getElementById("root")).render(it.jsx(ev.StrictMode,{children:it.jsx(xE,{})}));
